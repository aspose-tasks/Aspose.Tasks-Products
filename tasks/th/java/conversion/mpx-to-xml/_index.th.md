---
title: แปลง MPX เป็น XML ผ่าน Java 
url: /th/java/conversion/mpx-to-xml/ 
description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ MPX เป็นไฟล์ XML ใช้โค้ดตัวอย่างนี้เพื่อแปลง MPX เป็น XML ภายในแอปพลิเคชันที่ใช้ Java บนเว็บหรือเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง MPX เป็น XML ผ่าน Java" h2="ส่งออก Microsoft Visio MPX เป็น XML โดยใช้ไลบรารี Java ดั้งเดิมโดยไม่มี Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง MPX เป็น XML โดยใช้ Java" %}}

เพื่อแสดง MPX เป็น XML เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง MPX เป็น XML ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ซอร์สโค้ดการแปลง MPX เป็น XML Java" offSpacer="" %}}
