...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XML เป็น XER โดยใช้ C ++" %}}

 ในการแปลง XML เป็น XER เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง XML เป็น XER ผ่าน C++" %}}
...
{{% blocks/products/pf/agp/code-block title="ซอร์สโค้ดการแปลง XML เป็น XER C++" offSpacer="" %}}
