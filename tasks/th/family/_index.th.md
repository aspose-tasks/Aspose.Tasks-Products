---
title: .NET Java และ C++ API สำหรับการจัดการและจัดการโครงการ 
weight: 10
url: /th/family
description: สร้างแก้ไข แปลงการพิมพ์และแสดงไฟล์ Microsoft Project MPP MPT MPX XML ในแอปพลิเคชัน .NET และ Java โดยใช้ไลบรารีที่เกี่ยวข้องโดยไม่ได้ติดตั้ง MS Project
---
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" productLink="/tasks/th/net/" >}}
กำหนดเป้าหมาย Windows Forms, ASP.NET, WPF, WCF หรือแอปพลิเคชันประเภทใดก็ได้ตาม .NET Framework 2.0 หรือใหม่กว่า
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" productLink="/tasks/th/java/" >}}
...
ไลบรารี C++ สำหรับอ่าน เขียน และแสดงไฟล์ Microsoft Project® โดยไม่ต้องใช้ Microsoft Project®
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="เอกสาร" href="https://docs.aspose.com/tasks/" >}}
{{< blocks/products/pf/slr-element name="รหัสแหล่งที่มา" href="https://github.com/aspose-tasks?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้อง Aspose.Tasks Product Family?" tabId="success-stories" >}}
