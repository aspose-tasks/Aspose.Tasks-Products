---
title: Konversi MPX ke SVG melalui C# 
url: /id/net/conversion/mpx-to-svg/ 
description: Kode sumber untuk konversi MPX ke SVG C#. Gunakan kode contoh API untuk file MPX batch ke konversi SVG dalam VB.NET Asp.NET atau aplikasi berbasis .NET apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi MPX ke SVG melalui C#" h2="Ekspor Microsoft® Project MPX ke SVG di .NET Framework, Mono, dan COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="SVG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MPX ke SVG Menggunakan C#" %}}

Untuk mengonversi MPX ke SVG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi MPX ke SVG melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi MPX ke SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi MPX ke SVG" sectionDescription="Check our live demos for [MPX to SVG conversion](https://products.aspose.app/tasks/conversion/mpx-to-svg) with following benefits." >}}
