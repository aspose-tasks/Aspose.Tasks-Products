---
title: Konversi MPP ke JPEG melalui Java 
url: /id/java/conversion/mpp-to-jpeg/ 
description: Contoh kode konversi Java untuk format MPP ke file JPEG. Gunakan kode contoh ini untuk mengonversi MPP ke JPEG dalam aplikasi berbasis Web atau Desktop Java apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi MPP ke JPEG melalui Java" h2="Ekspor Microsoft Visio MPP ke JPEG menggunakan pustaka Java asli tanpa Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MPP ke JPEG Menggunakan Java" %}}

Untuk merender MPP ke JPEG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi MPP ke JPEG melalui Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi Java MPP ke JPEG" offSpacer="" %}}
