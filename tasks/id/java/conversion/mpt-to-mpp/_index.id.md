---
title: Konversi MPT ke MPP melalui Java 
url: /id/java/conversion/mpt-to-mpp/ 
description: Contoh kode konversi Java untuk format MPT ke file MPP. Gunakan kode contoh ini untuk mengonversi MPT ke MPP dalam aplikasi berbasis Web atau Desktop Java apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi MPT ke MPP melalui Java" h2="Ekspor Microsoft Visio MPT ke MPP menggunakan pustaka Java asli tanpa Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MPT ke MPP Menggunakan Java" %}}

Untuk merender MPT ke MPP, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi MPT ke MPP melalui Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi Java MPT ke MPP" offSpacer="" %}}
