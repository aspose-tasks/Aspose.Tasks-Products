---
title: .NET Java dan C++ API untuk Manajemen & Manipulasi Proyek 
weight: 10
url: /id/family
description: Buat edit, konversi, cetak, dan render file Microsoft Project MPP MPT MPX XML dalam aplikasi .NET & Java menggunakan perpustakaan yang relevan tanpa menginstal MS Project
---
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" productLink="/tasks/id/net/" >}}
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" productLink="/tasks/id/java/" >}}
...
Pustaka C++ untuk membaca, menulis, dan merender file Microsoft Project® tanpa menggunakan Microsoft Project®.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/tasks/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-tasks?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Keluarga Produk Aspose.Tasks?" tabId="success-stories" >}}
