---
title: Konversi MPP ke MPX melalui aplikasi C++ 
url: /id/cpp/conversion/mpp-to-mpx/ 
description: Contoh kode konversi C++ untuk dokumen MPP ke format MPX. Gunakan kode contoh untuk konversi batch MPP ke MPX dalam Aplikasi C++ apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi MPP ke MPX melalui C++" h2="Konversi MPP ke MPX berkinerja tinggi menggunakan pustaka C++ tanpa ketergantungan apa pun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
1. Lewati jalur file output dengan ekstensi file (MPX).
1. File MPX akan disimpan di jalur yang ditentukan.
1. Buka file MPX di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi MPP ke MPX C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi MPP ke MPX" sectionDescription="[Convert MPP to MPX](https://products.aspose.app/tasks/conversion/mpp-to-mpx) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
