---
title: Konversi MPT ke TXT melalui aplikasi C++ 
url: /id/cpp/conversion/mpt-to-txt/ 
description: Contoh kode konversi C++ untuk dokumen MPT ke format TXT. Gunakan kode contoh untuk konversi batch MPT ke TXT dalam Aplikasi C++ apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi MPT ke TXT melalui C++" h2="Konversi MPT ke TXT berkinerja tinggi menggunakan pustaka C++ tanpa ketergantungan apa pun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
1. Lewati jalur file output dengan ekstensi file (TXT).
1. File TXT akan disimpan di jalur yang ditentukan.
1. Buka file TXT di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi MPT ke TXT C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi MPT ke TXT" sectionDescription="[Convert MPT to TXT](https://products.aspose.app/tasks/conversion/mpt-to-txt) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
