---
title: Converteer MPT naar XER via C# 
url: /nl/net/conversion/mpt-to-xer/ 
description: Broncode voor conversie van MPT naar XER C#. Gebruik API-voorbeeldcode voor batch MPT-bestanden naar XER-conversie binnen VB.NET Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MPT naar XER via C#" h2="Exporteer Microsoft® Project MPT naar XER op .NET Framework, Mono en COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XER" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont MPT naar XER C#-conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om MPT naar XER te converteren" sectionDescription="Check our live demos for [MPT to XER conversion](https://products.aspose.app/tasks/conversion/mpt-to-xer) with following benefits." >}}
