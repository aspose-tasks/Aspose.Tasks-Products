---
title: Converteer MPT naar XER via C++ applicatie 
url: /nl/cpp/conversion/mpt-to-xer/ 
description: Voorbeeld van C++-conversiecode voor MPT-document naar XER-indeling. Gebruik voorbeeldcode voor batch-MPT naar XER-conversie binnen elke C++-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MPT naar XER via C++" h2="Hoogwaardige MPT naar XER-conversie met behulp van een C++-bibliotheek zonder enige afhankelijkheid." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe MPT naar XER te converteren met C++" %}}

 Om MPT naar XER te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om MPT naar XER te converteren via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT naar XER C++ conversie broncode" offSpacer="" %}}
