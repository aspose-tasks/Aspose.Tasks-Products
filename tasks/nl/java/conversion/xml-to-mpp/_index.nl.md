---
title: Converteer XML naar MPP via Java 
url: /nl/java/conversion/xml-to-mpp/ 
description: Voorbeeld Java-conversiecode voor XML-indeling naar MPP-bestand. Gebruik deze voorbeeldcode om XML naar MPP te converteren binnen een web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XML naar MPP via Java" h2="Exporteer Microsoft Visio XML naar MPP met behulp van native Java-bibliotheek zonder Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XML naar MPP te converteren met Java" %}}

Om XML naar MPP te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XML naar MPP te converteren via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XML naar MPP Java-conversie broncode" offSpacer="" %}}
