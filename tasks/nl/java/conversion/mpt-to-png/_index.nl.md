---
title: Converteer MPT naar PNG via Java 
url: /nl/java/conversion/mpt-to-png/ 
description: Voorbeeld Java-conversiecode voor MPT-indeling naar PNG-bestand. Gebruik deze voorbeeldcode om MPT naar PNG te converteren binnen een web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MPT naar PNG via Java" h2="Exporteer Microsoft Visio MPT naar PNG met behulp van native Java-bibliotheek zonder Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe MPT naar PNG te converteren met Java" %}}

Om MPT naar PNG te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om MPT naar PNG te converteren via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT naar PNG Java-conversie broncode" offSpacer="" %}}
