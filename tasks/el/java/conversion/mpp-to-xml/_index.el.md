...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε MPP σε XML χρησιμοποιώντας Java" %}}

Για να αποδώσουμε το MPP σε XML, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή MPP σε XML μέσω Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής Java σε MPP σε XML" offSpacer="" %}}
