---
title: Μετατροπή MPX σε MPT μέσω C# 
url: /el/net/conversion/mpx-to-mpt/ 
description: Πηγαίος κώδικας για μετατροπή MPX σε MPT C#. Χρησιμοποιήστε παράδειγμα κώδικα API για ομαδική μετατροπή αρχείων MPX σε MPT μέσα στο VB.NET Asp.NET ή σε οποιαδήποτε εφαρμογή που βασίζεται σε .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή MPX σε MPT μέσω C#" h2="Εξαγωγή Microsoft® Project MPX σε MPT σε .NET Framework, Mono και COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPT" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε MPX σε MPT χρησιμοποιώντας C#" %}}

Για να μετατρέψουμε το MPX σε MPT, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή MPX σε MPT μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή MPX σε MPT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Δωρεάν εφαρμογή για μετατροπή MPX σε MPT" sectionDescription="Check our live demos for [MPX to MPT conversion](https://products.aspose.app/tasks/conversion/mpx-to-mpt) with following benefits." >}}
