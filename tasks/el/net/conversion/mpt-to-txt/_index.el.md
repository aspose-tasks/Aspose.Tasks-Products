---
title: Μετατροπή MPT σε TXT μέσω C# 
url: /el/net/conversion/mpt-to-txt/ 
description: Πηγαίος κώδικας για μετατροπή MPT σε TXT C#. Χρησιμοποιήστε παράδειγμα κώδικα API για ομαδική μετατροπή αρχείων MPT σε TXT μέσα στο VB.NET Asp.NET ή σε οποιαδήποτε εφαρμογή που βασίζεται σε .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή MPT σε TXT μέσω C#" h2="Εξαγωγή Microsoft® Project MPT σε TXT σε .NET Framework, Mono και COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TXT" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε MPT σε TXT χρησιμοποιώντας C#" %}}

Για να μετατρέψουμε το MPT σε TXT, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή MPT σε TXT μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή MPT σε TXT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Δωρεάν εφαρμογή για μετατροπή MPT σε TXT" sectionDescription="Check our live demos for [MPT to TXT conversion](https://products.aspose.app/tasks/conversion/mpt-to-txt) with following benefits." >}}
