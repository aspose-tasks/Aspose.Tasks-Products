...
{{< blocks/products/pf/i18n/upper-banner h1="Microsoft Project Format File API" h2="Εγγενή API για .NET, Java και C++ για δημιουργία, επεξεργασία και μετατροπή αρχείων Microsoft Project." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks.svg" pfName="Aspose.Tasks" downloadUrl="https://releases.aspose.com/tasks" tryOnlineUrl="" >}}
