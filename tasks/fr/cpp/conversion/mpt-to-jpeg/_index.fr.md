---
title: Convertir MPT en JPEG via une application C++ 
url: /fr/cpp/conversion/mpt-to-jpeg/ 
description: Exemple de code de conversion C++ pour le document MPT au format JPEG. Utilisez un exemple de code pour la conversion par lots de MPT en JPEG dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en JPEG via C++" h2="Conversion MPT vers JPEG haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en JPEG en utilisant C++" %}}

 Pour convertir MPT en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPT en JPEG via C++" %}}
...
1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JPEG).
1. Le fichier JPEG sera enregistré dans le chemin spécifié.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPT vers JPEG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPT en JPEG" sectionDescription="[Convert MPT to JPEG](https://products.aspose.app/tasks/conversion/mpt-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
