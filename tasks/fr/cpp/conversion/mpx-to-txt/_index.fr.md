---
title: Convertir MPX en TXT via une application C++ 
url: /fr/cpp/conversion/mpx-to-txt/ 
description: Exemple de code de conversion C++ pour le document MPX au format TXT. Utilisez un exemple de code pour la conversion par lots de MPX en TXT dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPX en TXT via C++" h2="Conversion MPX vers TXT haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPX en TXT en utilisant C++" %}}
...
1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (TXT).
1. Le fichier TXT sera enregistré dans le chemin spécifié.
1. Ouvrez le fichier TXT dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPX vers TXT C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPX en TXT" sectionDescription="[Convert MPX to TXT](https://products.aspose.app/tasks/conversion/mpx-to-txt) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
