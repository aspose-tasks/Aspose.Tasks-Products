---
title: Convertir MPP en JPEG via une application C++ 
url: /fr/cpp/conversion/mpp-to-jpeg/ 
description: Exemple de code de conversion C++ pour le document MPP au format JPEG. Utilisez un exemple de code pour la conversion par lots de MPP en JPEG dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPP en JPEG via C++" h2="Conversion MPP vers JPEG haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPP en JPEG en utilisant C++" %}}

 Pour convertir MPP en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPP en JPEG via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPP vers JPEG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPP en JPEG" sectionDescription="[Convert MPP to JPEG](https://products.aspose.app/tasks/conversion/mpp-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
