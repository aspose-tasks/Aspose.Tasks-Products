---
title: Convertir MPT en XLSX via une application C++ 
url: /fr/cpp/conversion/mpt-to-xlsx/ 
description: Exemple de code de conversion C++ pour le document MPT au format XLSX. Utilisez un exemple de code pour la conversion par lots de MPT en XLSX dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en XLSX via C++" h2="Conversion MPT vers XLSX haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en XLSX en utilisant C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPT vers XLSX C++" offSpacer="" %}}
