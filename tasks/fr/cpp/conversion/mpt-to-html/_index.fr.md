---
title: Convertir MPT en HTML via une application C++ 
url: /fr/cpp/conversion/mpt-to-html/ 
description: Exemple de code de conversion C++ pour le document MPT au format HTML. Utilisez un exemple de code pour la conversion par lots de MPT en HTML dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en HTML via C++" h2="Conversion MPT vers HTML haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en HTML en utilisant C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPT vers HTML C++" offSpacer="" %}}
