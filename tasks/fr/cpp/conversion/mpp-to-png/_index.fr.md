---
title: Convertir MPP en PNG via une application C++ 
url: /fr/cpp/conversion/mpp-to-png/ 
description: Exemple de code de conversion C++ pour le document MPP au format PNG. Utilisez un exemple de code pour la conversion par lots de MPP en PNG dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPP en PNG via C++" h2="Conversion MPP vers PNG haute performance à l'aide de la bibliothèque C++ sans aucune dépendance." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPP en PNG en utilisant C++" %}}

 Pour convertir MPP en PNG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPP en PNG via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPP vers PNG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPP en PNG" sectionDescription="[Convert MPP to PNG](https://products.aspose.app/tasks/conversion/mpp-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
