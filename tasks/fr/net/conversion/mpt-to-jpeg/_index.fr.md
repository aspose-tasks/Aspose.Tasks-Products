---
title: Convertir MPT en JPEG via C# 
url: /fr/net/conversion/mpt-to-jpeg/ 
description: Code source pour la conversion MPT en JPEG C#. Utilisez le code d'exemple d'API pour les fichiers MPT par lots en conversion JPEG dans VB.NET Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en JPEG via C#" h2="Exportez Microsoft® Project MPT vers JPEG sur .NET Framework, Mono et COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en JPEG à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion MPT en JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPT en JPEG" sectionDescription="Check our live demos for [MPT to JPEG conversion](https://products.aspose.app/tasks/conversion/mpt-to-jpeg) with following benefits." >}}
