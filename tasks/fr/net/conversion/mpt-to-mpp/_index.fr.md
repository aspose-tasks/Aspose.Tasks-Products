---
title: Convertir MPT en MPP via C# 
url: /fr/net/conversion/mpt-to-mpp/ 
description: Code source pour la conversion MPT en MPP C#. Utilisez le code d'exemple d'API pour les fichiers MPT par lots en conversion MPP dans VB.NET Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en MPP via C#" h2="Exportez Microsoft® Project MPT vers MPP sur .NET Framework, Mono et COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en MPP à l'aide de C#" %}}

Pour convertir MPT en MPP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPT en MPP via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion MPT en MPP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPT en MPP" sectionDescription="Check our live demos for [MPT to MPP conversion](https://products.aspose.app/tasks/conversion/mpt-to-mpp) with following benefits." >}}
