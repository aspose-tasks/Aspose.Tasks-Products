---
title: Convertir MPT en XLSX via C# 
url: /fr/net/conversion/mpt-to-xlsx/ 
description: Code source pour la conversion MPT en XLSX C#. Utilisez le code d'exemple d'API pour les fichiers MPT par lots en conversion XLSX dans VB.NET Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT en XLSX via C#" h2="Exportez Microsoft® Project MPT vers XLSX sur .NET Framework, Mono et COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPT en XLSX à l'aide de C#" %}}

Pour convertir MPT en XLSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPT en XLSX via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion MPT en XLSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPT en XLSX" sectionDescription="Check our live demos for [MPT to XLSX conversion](https://products.aspose.app/tasks/conversion/mpt-to-xlsx) with following benefits." >}}
