---
title: Convertir MPP en TIF via C# 
url: /fr/net/conversion/mpp-to-tif/ 
description: Code source pour la conversion MPP en TIF C#. Utilisez le code d'exemple d'API pour les fichiers MPP par lots en conversion TIF dans VB.NET Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPP en TIF via C#" h2="Exportez Microsoft® Project MPP vers TIF sur .NET Framework, Mono et COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TIF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPP en TIF à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion MPP en TIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPP en TIF" sectionDescription="Check our live demos for [MPP to TIF conversion](https://products.aspose.app/tasks/conversion/mpp-to-tif) with following benefits." >}}
