---
title: Convertir MPP en XLSX via C# 
url: /fr/net/conversion/mpp-to-xlsx/ 
description: Code source pour la conversion MPP en XLSX C#. Utilisez le code d'exemple d'API pour les fichiers MPP par lots en conversion XLSX dans VB.NET Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPP en XLSX via C#" h2="Exportez Microsoft® Project MPP vers XLSX sur .NET Framework, Mono et COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPP en XLSX à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion MPP en XLSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir MPP en XLSX" sectionDescription="Check our live demos for [MPP to XLSX conversion](https://products.aspose.app/tasks/conversion/mpp-to-xlsx) with following benefits." >}}
