---
title: Convertir MPX en SVG via Java 
url: /fr/java/conversion/mpx-to-svg/ 
description: Exemple de code de conversion Java pour le format MPX en fichier SVG. Utilisez cet exemple de code pour convertir MPX en SVG dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPX en SVG via Java" h2="Exportez Microsoft Visio MPX au format SVG à l'aide de la bibliothèque Java native sans Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPX en SVG en utilisant Java" %}}

Afin de rendre MPX en SVG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPX en SVG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPX en SVG Java" offSpacer="" %}}
