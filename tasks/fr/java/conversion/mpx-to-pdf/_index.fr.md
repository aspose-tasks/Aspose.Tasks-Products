---
title: Convertir MPX en PDF via Java 
url: /fr/java/conversion/mpx-to-pdf/ 
description: Exemple de code de conversion Java pour le format MPX en fichier PDF. Utilisez cet exemple de code pour convertir MPX en PDF dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPX en PDF via Java" h2="Exportez Microsoft Visio MPX au format PDF à l'aide de la bibliothèque Java native sans Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MPX en PDF en utilisant Java" %}}

Afin de rendre MPX en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MPX en PDF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MPX en PDF Java" offSpacer="" %}}
