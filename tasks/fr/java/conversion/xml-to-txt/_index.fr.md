---
title: Convertir XML en TXT via Java 
url: /fr/java/conversion/xml-to-txt/ 
description: Exemple de code de conversion Java pour le format XML en fichier TXT. Utilisez cet exemple de code pour convertir XML en TXT dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XML en TXT via Java" h2="Exportez Microsoft Visio XML au format TXT à l'aide de la bibliothèque Java native sans Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en TXT en utilisant Java" %}}

Afin de rendre XML en TXT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XML en TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XML en TXT Java" offSpacer="" %}}
