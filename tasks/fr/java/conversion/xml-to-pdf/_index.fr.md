---
title: Convertir XML en PDF via Java 
url: /fr/java/conversion/xml-to-pdf/ 
description: Exemple de code de conversion Java pour le format XML en fichier PDF. Utilisez cet exemple de code pour convertir XML en PDF dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XML en PDF via Java" h2="Exportez Microsoft Visio XML au format PDF à l'aide de la bibliothèque Java native sans Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en PDF en utilisant Java" %}}

Afin de rendre XML en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XML en PDF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XML en PDF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir XML en PDF" sectionDescription="[Convert XML to PDF](https://products.aspose.app/tasks/conversion/xml-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
