---
title: Convert MPT to XLS via Java 
weight: 160
url: /java/conversion/mpt-to-xls/ 
description: Sample Java conversion code for MPT format to XLS file. Use this example code to convert MPT to XLS within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MPT to XLS via Java" h2="Export Microsoft Visio MPT to XLS using native Java library without Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="XLS" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MPT to XLS Using Java" %}}

 In order to render MPT to XLS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MPT to XLS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT to XLS Java Conversion Source Code" offSpacer="" %}}

{{< gist "aspose-com-gists" "217f0999451404991cca03101961f026" "convert-mpt-to-xls.java" >}}
