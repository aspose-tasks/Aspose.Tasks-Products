...
In order to render MPX to TIF, we’ll use <a href="https://products.aspose.com/tasks/java">Aspose.Tasks for Java</a> API which is a feature-rich, powerful and easy to use conversion API for Java platform. You can download its latest version directly from <a href="https://repository.aspose.com/tasks/">Maven</a> and install it within your Maven-based project by adding the following configurations to the pom.xml.
