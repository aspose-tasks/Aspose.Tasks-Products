---
title: Convert MPP to JIRA via Java 
weight: 1230
url: /java/conversion/mpp-to-jira/ 
description: Sample Java conversion code for MPP format to JIRA file. Use this example code to convert MPP to JIRA within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MPP to JIRA via Java" h2="Export Microsoft Visio MPP to JIRA using native Java library without Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JIRA" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MPP to JIRA Using Java" %}}

 In order to render MPP to JIRA, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MPP to JIRA via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily convert MPP file to JIRA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="MPP to JIRA Java Conversion Source Code" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="MPP to JIRA Conversion Live Demos" sectionDescription="[Convert MPP to JIRA](https://products.aspose.app/tasks/conversion/mpp-to-jira) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your MPP file, it will be converted instantly to JIRA." >}}
