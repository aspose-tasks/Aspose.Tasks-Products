---
title: View XML File Formats via Java
weight: 330
url: /java/viewer/xml/ 
description: Source code to load, render and display XML documents on Java
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="XML File Viewer for Java" h2="View Microsoft Project XML files in any browser without requiring Project application or Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="Aspose.Tasks" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="How to View XML File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View XML via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java code to view XML" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/tasks/java/viewer/mpx/" name="MPX" description="Microsoft Exchange File Format" >}}
