---
title: Merge MPX to JIRA via C# 
weight: 670
url: /net/merger/mpx-to-jira/ 
description: Sample code for MPX to JIRA C# merging. Use API example code for batch MPX files to JIRA merging within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge MPX to JIRA via C#" h2="Export MPX to JIRA on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge MPX to JIRA Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge MPX to JIRA via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPX to JIRA C# Merging" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "merge-mpx-to-jira.cs" >}}
