---
title: Merge PRIMAVERA XER to PDF via C# 
weight: 670
url: /net/merger/primavera-xer-to-pdf/ 
description: Sample code for PRIMAVERA XER to PDF C# merging. Use API example code for batch PRIMAVERA XER files to PDF merging within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PRIMAVERA XER to PDF via C#" h2="Export PRIMAVERA XER to PDF on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="PRIMAVERA XER" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge PRIMAVERA XER to PDF Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge PRIMAVERA XER to PDF via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PRIMAVERA XER to PDF C# Merging" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "merge-primavera-xer-to-pdf.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Merge PRIMAVERA XER to PDF" sectionDescription="Check our live demos for [PRIMAVERA XER to PDF merging](https://products.aspose.app/tasks/merger/primavera-xer-to-pdf) with following benefits." >}}
