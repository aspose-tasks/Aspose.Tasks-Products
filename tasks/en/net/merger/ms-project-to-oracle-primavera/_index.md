...
weight: 670
url: /net/merger/ms-project-to-oracle-primavera/ 
description: Sample code for MS PROJECT to ORACLE PRIMAVERA C# merging. Use API example code for batch MS PROJECT files to ORACLE PRIMAVERA merging within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge MS PROJECT to ORACLE PRIMAVERA via C#" h2="Export MS PROJECT to ORACLE PRIMAVERA on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="MS PROJECT" fileiconsmall5="BMP" >}}
...
{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "merge-ms-project-to-oracle-primavera.cs" >}}
