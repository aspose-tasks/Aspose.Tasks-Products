---
title: Unlock MS Project Tasks Files via .NET  
weight: 1130
url: /net/unlock/ 
description: Source code for unlock MS Project files via .NET? All you need is to Use API example code for batch JIRA files to unlock MPP file within VB.NET Asp.NET or any .NET 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Unlock MS Project Tasks Files" h2="Build your own .NET apps to Unlock MS Project Tasks Files files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="Aspose.Tasks" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Unlock MS Project Using C#" %}}
 ...
 API which is a feature-rich, powerful and easy to use document Unlock MS Project API for C# platform. Open
...
{{% blocks/products/pf/agp/code-block title="Unlock MS Project - C#" offSpacer="" %}}
