...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily load & convert MPP files to JIRA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPP to JIRA C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-mpp-to-jira.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MPP to JIRA" sectionDescription="Check our live demos for [MPP to JIRA conversion](https://products.aspose.app/tasks/conversion/mpp-to-jira) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/tasks/net/conversion/mpp-to-jira" name="MPP TO BMP" description="Bitmap Image File" >}}
