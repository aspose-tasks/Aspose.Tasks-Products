---
title: Convert PRIMAVERA XML to SVG via C# 
url: /net/conversion/primavera-xml-to-svg/ 
description: Sample code for PRIMAVERA XML to SVG C# conversion. Use API example code for batch XML files to HTML conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PRIMAVERA XML to SVG via C#" h2="Export PRIMAVERA XML to SVG on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.TASKS" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="TASKS" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
In order to Convert PRIMAVERA XML to SVG, we’ll use <a href="https://products.aspose.com/tasks/net">Aspose.Tasks for .NET</a> API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open <a href="https://www.nuget.org/packages/aspose.tasks">NuGet</a> package manager, search for <b>Aspose.Tasks</b> and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PRIMAVERA XML to SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.TASKS makes it easy for the developers to load & convert PRIMAVERA XML files to SVG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PRIMAVERA XML to SVG C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-primavera-xml-to-svg.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PRIMAVERA XML to SVG" sectionDescription="Check our live demos for [PRIMAVERA XML to SVG conversion](https://products.aspose.app/tasks/conversion/primavera-xml-to-svg) with following benefits." >}}
