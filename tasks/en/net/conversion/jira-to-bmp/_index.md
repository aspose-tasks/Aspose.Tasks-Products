---
title: Convert JIRA to BMP via C# 
weight: 670
...
{{% blocks/products/pf/agp/content h2="How to Convert JIRA to BMP Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert JIRA to BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily load & convert JIRA files to BMP in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows JIRA to BMP C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-jira-to-bmp.cs" >}}
