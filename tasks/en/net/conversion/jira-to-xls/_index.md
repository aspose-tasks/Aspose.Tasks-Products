...
{{% blocks/products/pf/agp/content h2="How to Convert JIRA to XLS Using C#" %}}

 In order to Convert JIRA to XLS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert JIRA to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily load & convert JIRA files to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows JIRA to XLS C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-jira-to-xls.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert JIRA to XLS" sectionDescription="Check our live demos for [JIRA to XLS conversion](https://products.aspose.app/tasks/conversion/jira-to-xls) with following benefits." >}}
