---
title: Convert PRIMAVERA XML to XPS via C# 
weight: 670
url: /net/conversion/primavera-xml-to-xps/ 
description: Sample code for PRIMAVERA XML to XPS C# conversion. Use API example code for batch PRIMAVERA XML files to XPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PRIMAVERA XML to XPS via C#" h2="Export PRIMAVERA XML to XPS on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="XPS" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PRIMAVERA XML to XPS Using C#" %}}

 In order to Convert PRIMAVERA XML to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PRIMAVERA XML to XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily load & convert PRIMAVERA XML files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PRIMAVERA XML to XPS C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-primavera-xml-to-xps.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PRIMAVERA XML to XPS" sectionDescription="Check our live demos for [PRIMAVERA XML to XPS conversion](https://products.aspose.app/tasks/conversion/primavera-xml-to-xps) with following benefits." >}}
