---
title: Convert MPX to XLS via C# 
weight: 850
url: /net/conversion/mpx-to-xls/ 
description: Sample code for MPX to XLS C# conversion. Use API example code for batch MPX files to XLS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MPX to XLS via C#" h2="Export Microsoft® Project MPX to XLS on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="XLS" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MPX to XLS Using C#" %}}

 In order to convert MPX to XLS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MPX to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Developers can easily load & convert MPX files to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPX to XLS C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-mpx-to-xls.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MPX to XLS" sectionDescription="Check our live demos for [MPX to XLS conversion](https://products.aspose.app/tasks/conversion/mpx-to-xls) with following benefits." >}}
