---
title: 通过 C# 将 MPX 转换为 XLSX 
url: /zh/net/conversion/mpx-to-xlsx/ 
description: MPX 到 XLSX C# 转换的源代码。使用 API 示例代码在 VB.NET Asp.NET 或任何基于 .NET 的应用程序中将 MPX 文件批量转换为 XLSX。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 MPX 转换为 XLSX" h2="在 .NET Framework、Mono 和 COM 互操作上将 Microsoft® Project MPX 导出为 XLSX。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 MPX 到 XLSX C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 MPX 转换为 XLSX 的免费应用程序" sectionDescription="Check our live demos for [MPX to XLSX conversion](https://products.aspose.app/tasks/conversion/mpx-to-xlsx) with following benefits." >}}
