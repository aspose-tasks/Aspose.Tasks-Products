---
title: 通过 C++ 应用程序将 MPT 转换为 JPEG 
url: /zh/cpp/conversion/mpt-to-jpeg/ 
description: MPT 文档到 JPEG 格式的示例 C++ 转换代码。在任何 C++ 应用程序中使用示例代码将 MPT 批量转换为 JPEG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 MPT 转换为 JPEG" h2="使用 C++ 库的高性能 MPT 到 JPEG 转换，没有任何依赖。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/code-block title="MPT 到 JPEG C++ 转换源代码" offSpacer="" %}}
