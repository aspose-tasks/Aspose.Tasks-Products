---
title: MPT konvertálása HTML-be C++ alkalmazással 
url: /hu/cpp/conversion/mpt-to-html/ 
description: Minta C++ konverziós kód MPT dokumentumhoz HTML formátumba. Használjon példakódot az MPT-ből HTML-be történő kötegelt konvertálásához bármely C++ alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPT konvertálása HTML-re C++ segítségével" h2="Nagy teljesítményű MPT konvertálás HTML-be C++ könyvtár használatával, mindenféle függőség nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet MPT-t HTML-vé konvertálni C++ használatával" %}}

 Az MPT HTML-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MPT HTML-vé konvertálásához C++ segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT-ből HTML-be C++ konverziós forráskód" offSpacer="" %}}
