---
title: MPT konvertálása SVG-re Java segítségével 
url: /hu/java/conversion/mpt-to-svg/ 
description: Java konverziós kód minta MPT formátumhoz SVG fájlba. Ezzel a példakóddal konvertálhat MPT-t SVG-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPT konvertálása SVG-re Java segítségével" h2="Exportálja a Microsoft Visio MPT-t SVG formátumba natív Java-könyvtár használatával, Office Automation nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet MPT-t SVG-re konvertálni Java segítségével" %}}

Ahhoz, hogy az MPT-t SVG-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MPT SVG-vé konvertálásához Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT–SVG Java konverziós forráskód" offSpacer="" %}}
