---
title: MPP konvertálása XLSX-re Java segítségével 
url: /hu/java/conversion/mpp-to-xlsx/ 
description: Java konverziós kód minta MPP formátumhoz XLSX fájlba. Ezzel a példakóddal konvertálhat MPP-t XLSX-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPP konvertálása XLSX-re Java segítségével" h2="Exportálja a Microsoft Visio MPP-t XLSX formátumba natív Java-könyvtár használatával, Office Automation nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet MPP-t XLSX-re konvertálni Java segítségével" %}}

Ahhoz, hogy az MPP-t XLSX-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MPP XLSX-vé konvertálásához Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP–XLSX Java konverziós forráskód" offSpacer="" %}}
