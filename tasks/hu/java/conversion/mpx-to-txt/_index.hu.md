---
title: MPX konvertálása TXT-re Java segítségével 
url: /hu/java/conversion/mpx-to-txt/ 
description: Java konverziós kód minta MPX formátumhoz TXT fájlba. Ezzel a példakóddal konvertálhat MPX-t TXT-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPX konvertálása TXT-re Java segítségével" h2="Exportálja a Microsoft Visio MPX-t TXT formátumba natív Java-könyvtár használatával, Office Automation nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet MPX-t TXT-re konvertálni Java segítségével" %}}

Ahhoz, hogy az MPX-t TXT-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MPX TXT-vé konvertálásához Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX–TXT Java konverziós forráskód" offSpacer="" %}}
