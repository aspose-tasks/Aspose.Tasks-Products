---
title: MPT konvertálása MPP-re Java segítségével 
url: /hu/java/conversion/mpt-to-mpp/ 
description: Java konverziós kód minta MPT formátumhoz MPP fájlba. Ezzel a példakóddal konvertálhat MPT-t MPP-vé bármely webes vagy asztali Java alapú alkalmazásban.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPT konvertálása MPP-re Java segítségével" h2="Exportálja a Microsoft Visio MPT-t MPP formátumba natív Java-könyvtár használatával, Office Automation nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet MPT-t MPP-re konvertálni Java segítségével" %}}

Ahhoz, hogy az MPT-t MPP-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MPT MPP-vé konvertálásához Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT–MPP Java konverziós forráskód" offSpacer="" %}}
