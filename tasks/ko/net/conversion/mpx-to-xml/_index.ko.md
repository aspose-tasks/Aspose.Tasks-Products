---
title: C#을 통해 MPX를 XML로 변환 
url: /ko/net/conversion/mpx-to-xml/ 
description: MPX에서 XML C#으로의 변환을 위한 소스 코드입니다. VB.NET Asp.NET 또는 .NET 기반 응용 프로그램 내에서 배치 MPX 파일을 XML로 변환하는 API 예제 코드를 사용합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 MPX를 XML로 변환" h2=".NET Framework, Mono 및 COM Interop에서 Microsoft® Project MPX를 XML로 내보냅니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 MPX를 XML로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 MPX를 XML로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 MPX에서 XML C#으로의 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="MPX를 XML로 변환하는 무료 앱" sectionDescription="Check our live demos for [MPX to XML conversion](https://products.aspose.app/tasks/conversion/mpx-to-xml) with following benefits." >}}
