---
title: Convert XML to MPX via C# 
weight: 840
url: /net/conversion/xml-to-mpx/ 
description: Sample code for XML to MPX C# conversion. Use API example code for batch XML files to MPX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily load & convert XML files to MPX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XML to MPX C# Conversion" offSpacer="" %}}
