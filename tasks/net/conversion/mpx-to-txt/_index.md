---
title: Convert MPX to TXT via C# 
weight: 870
url: /net/conversion/mpx-to-txt/ 
description: Sample code for MPX to TXT C# conversion. Use API example code for batch MPX files to TXT conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily load & convert MPX files to TXT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPX to TXT C# Conversion" offSpacer="" %}}
