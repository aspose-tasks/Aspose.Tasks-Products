---
title: Convert MPX to TXT via .NET 
weight: 870
...
{{% blocks/products/pf/agp/content h2="Export Microsoft" %}}
 ...
 In order to convert MPX to TXT, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Tasks makes it easy for the developers to load & convert MPX files to TXT in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MPX to TXT" sectionDescription="Check our live demos for [MPX to TXT conversion](https://products.aspose.app/tasks/conversion/mpx-to-txt) with following benefits." >}}
