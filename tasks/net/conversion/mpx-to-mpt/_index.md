---
title: Convert MPX to MPT via C# 
weight: 360
url: /net/conversion/mpx-to-mpt/ 
description: Sample code for MPX to MPT C# conversion. Use API example code for batch MPX files to MPT conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MPX to MPT via C#" h2="Export Microsoft® Project MPX to MPT on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="Aspose.Tasks" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Tasks makes it easy for the developers to load & convert MPX files to MPT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPX to MPT C# Conversion" offSpacer="" %}}

```cs
// load the MPX in an object of Project class
var project = new Aspose.Tasks.Project("template.mpx");
// save MPX as MPT 
project.Save("output.mpt", Aspose.Tasks.Saving.SaveFileFormat.MPT); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MPX to MPT" sectionDescription="Check our live demos for [MPX to MPT conversion](https://products.aspose.app/tasks/conversion/mpx-to-mpt) with following benefits." >}}
