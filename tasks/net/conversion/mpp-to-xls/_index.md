...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily load & convert MPP files to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPP to XLS C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0484545ed20cb073e4bcf7ce894343f0" "convert-mpp-to-xls.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MPP to XLS" sectionDescription="Check our live demos for [MPP to XLS conversion](https://products.aspose.app/tasks/conversion/mpp-to-xls) with following benefits." >}}
