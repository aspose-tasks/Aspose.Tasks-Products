---
title: Convert MPX to XER via C# 
weight: 1290
url: /net/conversion/mpx-to-xer/ 
description: Sample code for MPX to XER C# conversion. Use API example code for batch MPX files to XER conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MPX to XER via C#" h2="Export Microsoft® Project MPX to XER on .NET Framework, Mono and COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Developers can easily load & convert MPX files to XER in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MPX to XER C# Conversion" offSpacer="" %}}
