---
title: Chuyển đổi MPT sang TXT qua C# 
url: /vi/net/conversion/mpt-to-txt/ 
description: Mã nguồn để chuyển đổi MPT sang TXT C#. Sử dụng mã ví dụ API cho hàng loạt tệp MPT sang chuyển đổi TXT trong VB.NET Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi MPT sang TXT qua C#" h2="Xuất Microsoft® Project MPT sang TXT trên .NET Framework, Mono và COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TXT" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi MPT sang TXT qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi MPT sang TXT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi MPT sang TXT" sectionDescription="Check our live demos for [MPT to TXT conversion](https://products.aspose.app/tasks/conversion/mpt-to-txt) with following benefits." >}}
