---
title: Chuyển đổi MPX sang XLSX qua C # 
url: /vi/net/conversion/mpx-to-xlsx/ 
description: Mã nguồn để chuyển đổi MPX sang XLSX C #. Sử dụng mã ví dụ API cho hàng loạt tệp MPX sang chuyển đổi XLSX trong VB.NET Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi MPX sang XLSX qua C #" h2="Xuất Microsoft® Project MPX sang XLSX trên .NET Framework, Mono và COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi MPX sang XLSX qua C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi MPX sang XLSX C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi MPX sang XLSX" sectionDescription="Check our live demos for [MPX to XLSX conversion](https://products.aspose.app/tasks/conversion/mpx-to-xlsx) with following benefits." >}}
