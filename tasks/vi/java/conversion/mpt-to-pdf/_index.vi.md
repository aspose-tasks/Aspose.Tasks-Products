---
title: Chuyển đổi MPT sang PDF qua Java 
url: /vi/java/conversion/mpt-to-pdf/ 
description: Mã chuyển đổi Java mẫu cho định dạng MPT sang tệp PDF. Sử dụng mã ví dụ này để chuyển đổi MPT sang PDF trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính Java nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi MPT sang PDF qua Java" h2="Xuất Microsoft Visio MPT sang PDF bằng thư viện Java gốc mà không có Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển MPT sang PDF bằng Java" %}}

Để hiển thị MPT sang PDF, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi MPT sang PDF qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi MPT sang PDF Java" offSpacer="" %}}
