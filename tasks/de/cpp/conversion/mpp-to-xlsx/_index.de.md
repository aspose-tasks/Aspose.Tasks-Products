---
title: Konvertieren Sie MPP über eine C++-Anwendung in XLSX 
url: /de/cpp/conversion/mpp-to-xlsx/ 
description: Beispiel-C++-Konvertierungscode für das MPP-Dokument in das XLSX-Format. Verwenden Sie Beispielcode für die Batch-MPP-zu-XLSX-Konvertierung in einer beliebigen C++-Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPP über C++ in XLSX" h2="Leistungsstarke MPP-zu-XLSX-Konvertierung mit C++-Bibliothek ohne Abhängigkeit." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPP in XLSX mit C++" %}}

 Um MPP in XLSX zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPP in XLSX über C++" %}}
...
1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (XLSX).
1. Die XLSX-Datei wird unter dem angegebenen Pfad gespeichert.
1. Öffnen Sie die XLSX-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="MPP-zu-XLSX-C++-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von MPP in XLSX" sectionDescription="[Convert MPP to XLSX](https://products.aspose.app/tasks/conversion/mpp-to-xlsx) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
