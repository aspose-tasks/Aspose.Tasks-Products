---
title: Konvertieren Sie MPT über eine C++-Anwendung in HTML 
url: /de/cpp/conversion/mpt-to-html/ 
description: Beispiel-C++-Konvertierungscode für das MPT-Dokument in das HTML-Format. Verwenden Sie Beispielcode für die Batch-MPT-zu-HTML-Konvertierung in einer beliebigen C++-Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPT über C++ in HTML" h2="Leistungsstarke MPT-zu-HTML-Konvertierung mit C++-Bibliothek ohne Abhängigkeit." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/code-block title="MPT-zu-HTML-C++-Konvertierungsquellcode" offSpacer="" %}}
