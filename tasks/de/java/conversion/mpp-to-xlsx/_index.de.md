---
title: Konvertieren Sie MPP über Java in XLSX 
url: /de/java/conversion/mpp-to-xlsx/ 
description: Beispiel-Java-Konvertierungscode für das MPP-Format in eine XLSX-Datei. Verwenden Sie diesen Beispielcode, um MPP in XLSX in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPP über Java in XLSX" h2="Exportieren Sie Microsoft Visio MPP in XLSX mithilfe der nativen Java-Bibliothek ohne Office-Automatisierung." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPP in XLSX mit Java" %}}

Um MPP in XLSX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPP in XLSX über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP-zu-XLSX-Java-Konvertierungsquellcode" offSpacer="" %}}
