---
title: Konvertieren Sie MPP über Java in HTML 
url: /de/java/conversion/mpp-to-html/ 
description: Beispiel-Java-Konvertierungscode für das MPP-Format in eine HTML-Datei. Verwenden Sie diesen Beispielcode, um MPP in HTML in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPP über Java in HTML" h2="Exportieren Sie Microsoft Visio MPP in HTML mithilfe der nativen Java-Bibliothek ohne Office-Automatisierung." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPP in HTML mit Java" %}}

Um MPP in HTML zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPP in HTML über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP-zu-HTML-Java-Konvertierungsquellcode" offSpacer="" %}}
