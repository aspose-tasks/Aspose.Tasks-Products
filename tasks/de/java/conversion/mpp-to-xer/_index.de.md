...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPP in XER mit Java" %}}

Um MPP in XER zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPP in XER über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP-zu-XER-Java-Konvertierungsquellcode" offSpacer="" %}}
