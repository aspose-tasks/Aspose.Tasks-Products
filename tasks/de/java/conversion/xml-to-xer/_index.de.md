...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XML in XER mit Java" %}}

Um XML in XER zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XML in XER über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XML-zu-XER-Java-Konvertierungsquellcode" offSpacer="" %}}
