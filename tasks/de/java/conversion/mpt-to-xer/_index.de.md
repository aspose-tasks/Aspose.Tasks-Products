...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPT in XER mit Java" %}}

Um MPT in XER zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPT in XER über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT-zu-XER-Java-Konvertierungsquellcode" offSpacer="" %}}
