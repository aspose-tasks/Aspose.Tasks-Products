---
title: Konvertieren Sie MPX über Java in MPP 
url: /de/java/conversion/mpx-to-mpp/ 
description: Beispiel-Java-Konvertierungscode für das MPX-Format in eine MPP-Datei. Verwenden Sie diesen Beispielcode, um MPX in MPP in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPX über Java in MPP" h2="Exportieren Sie Microsoft Visio MPX in MPP mithilfe der nativen Java-Bibliothek ohne Office-Automatisierung." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPX in MPP mit Java" %}}

Um MPX in MPP zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPX in MPP über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX-zu-MPP-Java-Konvertierungsquellcode" offSpacer="" %}}
