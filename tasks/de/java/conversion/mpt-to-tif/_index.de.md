---
title: Konvertieren Sie MPT über Java in TIF 
url: /de/java/conversion/mpt-to-tif/ 
description: Beispiel-Java-Konvertierungscode für das MPT-Format in eine TIF-Datei. Verwenden Sie diesen Beispielcode, um MPT in TIF in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPT über Java in TIF" h2="Exportieren Sie Microsoft Visio MPT in TIF mithilfe der nativen Java-Bibliothek ohne Office-Automatisierung." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPT in TIF mit Java" %}}

Um MPT in TIF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPT in TIF über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT-zu-TIF-Java-Konvertierungsquellcode" offSpacer="" %}}
