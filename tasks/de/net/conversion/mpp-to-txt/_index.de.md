---
title: Konvertieren Sie MPP über C# in TXT 
url: /de/net/conversion/mpp-to-txt/ 
description: Quellcode für die MPP-zu-TXT-C#-Konvertierung. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von MPP-Dateien in TXT innerhalb von VB.NET Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MPP über C# in TXT" h2="Exportieren Sie Microsoft® Project MPP in TXT auf .NET Framework, Mono und COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="TXT" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MPP in TXT mit C#" %}}

Um MPP in TXT zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MPP in TXT über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die MPP-zu-TXT-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von MPP in TXT" sectionDescription="Check our live demos for [MPP to TXT conversion](https://products.aspose.app/tasks/conversion/mpp-to-txt) with following benefits." >}}
