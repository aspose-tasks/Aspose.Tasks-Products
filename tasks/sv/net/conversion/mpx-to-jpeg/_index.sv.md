...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar MPX till JPEG C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera MPX till JPEG" sectionDescription="Check our live demos for [MPX to JPEG conversion](https://products.aspose.app/tasks/conversion/mpx-to-jpeg) with following benefits." >}}
