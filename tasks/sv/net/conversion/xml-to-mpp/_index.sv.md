---
title: Konvertera XML till MPP via C# 
url: /sv/net/conversion/xml-to-mpp/ 
description: Källkod för konvertering av XML till MPP C#. Använd API-exempelkod för batch XML-filer till MPP-konvertering inom VB.NET Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XML till MPP via C#" h2="Exportera Microsoft® Project XML till MPP på .NET Framework, Mono och COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar XML till MPP C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera XML till MPP" sectionDescription="Check our live demos for [XML to MPP conversion](https://products.aspose.app/tasks/conversion/xml-to-mpp) with following benefits." >}}
