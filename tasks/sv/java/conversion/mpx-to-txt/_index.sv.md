...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MPX till TXT med Java" %}}

För att rendera MPX till TXT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MPX till TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX till TXT Java konvertering källkod" offSpacer="" %}}
