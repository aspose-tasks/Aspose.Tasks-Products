...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MPT till XER med Java" %}}

För att rendera MPT till XER kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MPT till XER via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT till XER Java konvertering källkod" offSpacer="" %}}
