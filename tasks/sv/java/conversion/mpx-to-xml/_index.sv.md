...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MPX till XML med Java" %}}

För att rendera MPX till XML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MPX till XML via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX till XML Java konvertering källkod" offSpacer="" %}}
