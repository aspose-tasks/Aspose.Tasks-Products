---
title: Konvertera MPP till JPEG via Java 
url: /sv/java/conversion/mpp-to-jpeg/ 
description: Exempel på Java-konverteringskod för MPP-format till JPEG-fil. Använd den här exempelkoden för att konvertera MPP till JPEG inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera MPP till JPEG via Java" h2="Exportera Microsoft Visio MPP till JPEG med inbyggt Java-bibliotek utan Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MPP till JPEG med Java" %}}

För att rendera MPP till JPEG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MPP till JPEG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP till JPEG Java konvertering källkod" offSpacer="" %}}
