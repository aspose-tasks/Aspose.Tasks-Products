---
title: Konvertera MPP till XLSX via C++-applikation 
url: /sv/cpp/conversion/mpp-to-xlsx/ 
description: Exempel på C++-konverteringskod för MPP-dokument till XLSX-format. Använd exempelkod för batch-MPP till XLSX-konvertering inom valfri C++-applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera MPP till XLSX via C++" h2="Högpresterande MPP till XLSX-konvertering med C++-bibliotek utan något beroende." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="MPP till XLSX C++ Källkod för konvertering" offSpacer="" %}}
