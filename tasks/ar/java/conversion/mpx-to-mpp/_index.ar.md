---
title: تحويل MPX إلى MPP عبر Java 
url: /ar/java/conversion/mpx-to-mpp/ 
description: نموذج كود تحويل Java لتنسيق MPX إلى ملف MPP. استخدم رمز المثال هذا لتحويل MPX إلى MPP داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى MPP عبر Java" h2="قم بتصدير Microsoft Visio MPX إلى MPP باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPX إلى MPP باستخدام Java" %}}

من أجل تقديم MPX إلى MPP ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPX إلى MPP عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل Java MPP" offSpacer="" %}}
