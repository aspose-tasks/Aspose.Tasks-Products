---
title: تحويل MPT إلى SVG عبر Java 
url: /ar/java/conversion/mpt-to-svg/ 
description: نموذج كود تحويل Java لتنسيق MPT إلى ملف SVG. استخدم رمز المثال هذا لتحويل MPT إلى SVG داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPT إلى SVG عبر Java" h2="قم بتصدير Microsoft Visio MPT إلى SVG باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPT إلى SVG باستخدام Java" %}}

من أجل تقديم MPT إلى SVG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPT إلى SVG عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT إلى كود مصدر تحويل Java SVG" offSpacer="" %}}
