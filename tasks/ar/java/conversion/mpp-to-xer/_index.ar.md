---
title: تحويل MPP إلى XER عبر Java 
url: /ar/java/conversion/mpp-to-xer/ 
description: نموذج كود تحويل Java لتنسيق MPP إلى ملف XER. استخدم رمز المثال هذا لتحويل MPP إلى XER داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPP إلى XER عبر Java" h2="قم بتصدير Microsoft Visio MPP إلى XER باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPP إلى XER باستخدام Java" %}}

من أجل تقديم MPP إلى XER ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPP إلى XER عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP إلى كود مصدر تحويل Java XER" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل MPP إلى XER" sectionDescription="[Convert MPP to XER](https://products.aspose.app/tasks/conversion/mpp-to-xer) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
