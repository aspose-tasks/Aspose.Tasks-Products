---
title: تحويل MPT إلى MPP عبر Java 
url: /ar/java/conversion/mpt-to-mpp/ 
description: نموذج كود تحويل Java لتنسيق MPT إلى ملف MPP. استخدم رمز المثال هذا لتحويل MPT إلى MPP داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPT إلى MPP عبر Java" h2="قم بتصدير Microsoft Visio MPT إلى MPP باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPT إلى MPP باستخدام Java" %}}

من أجل تقديم MPT إلى MPP ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPT إلى MPP عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT إلى كود مصدر تحويل Java MPP" offSpacer="" %}}
