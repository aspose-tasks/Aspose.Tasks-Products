---
title: تحويل MPT إلى JPEG عبر Java 
url: /ar/java/conversion/mpt-to-jpeg/ 
description: نموذج كود تحويل Java لتنسيق MPT إلى ملف JPEG. استخدم رمز المثال هذا لتحويل MPT إلى JPEG داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPT إلى JPEG عبر Java" h2="قم بتصدير Microsoft Visio MPT إلى JPEG باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPT إلى JPEG باستخدام Java" %}}

من أجل تقديم MPT إلى JPEG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPT إلى JPEG عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT إلى كود مصدر تحويل Java JPEG" offSpacer="" %}}
