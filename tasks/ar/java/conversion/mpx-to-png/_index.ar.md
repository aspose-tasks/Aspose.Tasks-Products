---
title: تحويل MPX إلى PNG عبر Java 
url: /ar/java/conversion/mpx-to-png/ 
description: نموذج كود تحويل Java لتنسيق MPX إلى ملف PNG. استخدم رمز المثال هذا لتحويل MPX إلى PNG داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى PNG عبر Java" h2="قم بتصدير Microsoft Visio MPX إلى PNG باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPX إلى PNG باستخدام Java" %}}

من أجل تقديم MPX إلى PNG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPX إلى PNG عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل Java PNG" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل MPX إلى PNG" sectionDescription="[Convert MPX to PNG](https://products.aspose.app/tasks/conversion/mpx-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
