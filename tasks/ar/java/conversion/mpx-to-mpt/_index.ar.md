---
title: تحويل MPX إلى MPT عبر Java 
url: /ar/java/conversion/mpx-to-mpt/ 
description: نموذج كود تحويل Java لتنسيق MPX إلى ملف MPT. استخدم رمز المثال هذا لتحويل MPX إلى MPT داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى MPT عبر Java" h2="قم بتصدير Microsoft Visio MPX إلى MPT باستخدام مكتبة Java الأصلية بدون أتمتة Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPX إلى MPT باستخدام Java" %}}

من أجل تقديم MPX إلى MPT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPX إلى MPT عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل Java MPT" offSpacer="" %}}
