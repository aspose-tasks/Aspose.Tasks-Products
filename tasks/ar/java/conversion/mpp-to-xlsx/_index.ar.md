...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPP إلى XLSX باستخدام Java" %}}

من أجل تقديم MPP إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPP إلى XLSX عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP إلى كود مصدر تحويل Java XLSX" offSpacer="" %}}
