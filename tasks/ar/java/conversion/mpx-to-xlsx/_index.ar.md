...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPX إلى XLSX باستخدام Java" %}}

من أجل تقديم MPX إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPX إلى XLSX عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل Java XLSX" offSpacer="" %}}
