---
title: تحويل MPX إلى XML عبر C# 
url: /ar/net/conversion/mpx-to-xml/ 
description: شفرة المصدر لتحويل MPX إلى XML C#. استخدم رمز مثال API لملفات MPX الدفعية لتحويل XML داخل VB.NET Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى XML عبر C#" h2="قم بتصدير Microsoft® Project MPX إلى XML على .NET Framework و Mono و COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية هذا تحويل MPX إلى XML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل MPX إلى XML" sectionDescription="Check our live demos for [MPX to XML conversion](https://products.aspose.app/tasks/conversion/mpx-to-xml) with following benefits." >}}
