---
title: NET Java و C ++ APIs لإدارة المشاريع ومعالجتها 
weight: 10
url: /ar/family
description: إنشاء تحرير وتحويل طباعة وعرض ملفات Microsoft Project MPP MPT MPX XML في تطبيقات .NET و Java باستخدام المكتبة ذات الصلة دون تثبيت MS Project
---
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" productLink="/tasks/ar/net/" >}}
الهدف Windows Forms أو ASP.NET أو WPF أو WCF أو أي نوع من التطبيقات يعتمد على .NET Framework 2.0 أو أحدث.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" productLink="/tasks/ar/java/" >}}
...
مكتبة C ++ لقراءة ملفات Microsoft Project® وكتابتها وعرضها دون استخدام Microsoft Project®.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/tasks/" >}}
{{< blocks/products/pf/slr-element name="مصدر الرمز" href="https://github.com/aspose-tasks?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Tasks عائلة المنتج؟" tabId="success-stories" >}}
