---
title: تحويل MPP إلى SVG عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpp-to-svg/ 
description: عينة كود تحويل C ++ لمستند MPP إلى تنسيق SVG. استخدم رمز المثال للتحويل الدفعي MPP إلى SVG داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPP إلى SVG عبر C ++" h2="تحويل MPP إلى SVG عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="MPP إلى كود مصدر تحويل SVG C ++" offSpacer="" %}}
