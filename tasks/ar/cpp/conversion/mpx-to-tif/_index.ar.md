---
title: تحويل MPX إلى TIF عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpx-to-tif/ 
description: عينة كود تحويل C ++ لمستند MPX إلى تنسيق TIF. استخدم رمز المثال للتحويل الدفعي MPX إلى TIF داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى TIF عبر C ++" h2="تحويل MPX إلى TIF عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPX إلى TIF باستخدام C ++" %}}

 من أجل تحويل MPX إلى TIF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPX إلى TIF عبر C ++" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل TIF C ++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل MPX إلى TIF" sectionDescription="[Convert MPX to TIF](https://products.aspose.app/tasks/conversion/mpx-to-tif) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
