...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XML إلى XLSX باستخدام C ++" %}}

 من أجل تحويل XML إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XML إلى XLSX عبر C ++" %}}
...
{{% blocks/products/pf/agp/code-block title="XML إلى كود مصدر تحويل XLSX C ++" offSpacer="" %}}
