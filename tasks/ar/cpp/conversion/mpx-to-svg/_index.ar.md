---
title: تحويل MPX إلى SVG عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpx-to-svg/ 
description: عينة كود تحويل C ++ لمستند MPX إلى تنسيق SVG. استخدم رمز المثال للتحويل الدفعي MPX إلى SVG داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى SVG عبر C ++" h2="تحويل MPX إلى SVG عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل SVG C ++" offSpacer="" %}}
