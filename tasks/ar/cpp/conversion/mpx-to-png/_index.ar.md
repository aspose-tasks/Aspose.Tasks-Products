---
title: تحويل MPX إلى PNG عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpx-to-png/ 
description: عينة كود تحويل C ++ لمستند MPX إلى تنسيق PNG. استخدم رمز المثال للتحويل الدفعي MPX إلى PNG داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى PNG عبر C ++" h2="تحويل MPX إلى PNG عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل PNG C ++" offSpacer="" %}}
