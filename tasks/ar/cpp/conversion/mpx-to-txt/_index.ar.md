---
title: تحويل MPX إلى TXT عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpx-to-txt/ 
description: عينة كود تحويل C ++ لمستند MPX إلى تنسيق TXT. استخدم رمز المثال للتحويل الدفعي MPX إلى TXT داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPX إلى TXT عبر C ++" h2="تحويل MPX إلى TXT عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="MPX إلى كود مصدر تحويل TXT C ++" offSpacer="" %}}
