---
title: تحويل MPP إلى XML عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpp-to-xml/ 
description: عينة كود تحويل C ++ لمستند MPP إلى تنسيق XML. استخدم رمز المثال للتحويل الدفعي MPP إلى XML داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPP إلى XML عبر C ++" h2="تحويل MPP إلى XML عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MPP إلى XML باستخدام C ++" %}}

 من أجل تحويل MPP إلى XML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MPP إلى XML عبر C ++" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP إلى كود مصدر تحويل XML C ++" offSpacer="" %}}
