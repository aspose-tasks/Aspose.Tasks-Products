---
title: تحويل MPP إلى XER عبر تطبيق C ++ 
url: /ar/cpp/conversion/mpp-to-xer/ 
description: عينة كود تحويل C ++ لمستند MPP إلى تنسيق XER. استخدم رمز المثال للتحويل الدفعي MPP إلى XER داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MPP إلى XER عبر C ++" h2="تحويل MPP إلى XER عالي الأداء باستخدام مكتبة C ++ دون أي تبعية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="MPP إلى كود مصدر تحويل XER C ++" offSpacer="" %}}
