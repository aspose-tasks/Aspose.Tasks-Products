---
title: Converti MPX in XML tramite C# 
url: /it/net/conversion/mpx-to-xml/ 
description: Codice sorgente per la conversione da MPX a XML C#. Utilizzare il codice di esempio API per la conversione batch di file MPX in XML all'interno di VB.NET Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti MPX in XML tramite C#" h2="Esporta Microsoft® Project MPX in XML su .NET Framework, Mono e COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da MPX a C# XML" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire MPX in XML" sectionDescription="Check our live demos for [MPX to XML conversion](https://products.aspose.app/tasks/conversion/mpx-to-xml) with following benefits." >}}
