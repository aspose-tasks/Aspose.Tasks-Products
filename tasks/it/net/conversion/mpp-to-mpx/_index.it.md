---
title: Converti MPP in MPX tramite C# 
url: /it/net/conversion/mpp-to-mpx/ 
description: Codice sorgente per la conversione da MPP a MPX C#. Utilizzare il codice di esempio API per la conversione batch di file MPP in MPX all'interno di VB.NET Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti MPP in MPX tramite C#" h2="Esporta Microsoft® Project MPP in MPX su .NET Framework, Mono e COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da MPP a C# MPX" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire MPP in MPX" sectionDescription="Check our live demos for [MPP to MPX conversion](https://products.aspose.app/tasks/conversion/mpp-to-mpx) with following benefits." >}}
