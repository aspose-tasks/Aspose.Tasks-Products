---
title: Converti MPP in XLSX tramite l'applicazione C++ 
url: /it/cpp/conversion/mpp-to-xlsx/ 
description: Esempio di codice di conversione C++ per documento MPP in formato XLSX. Utilizzare il codice di esempio per la conversione batch da MPP a XLSX all'interno di qualsiasi applicazione C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti MPP in XLSX tramite C++" h2="Conversione da MPP a XLSX ad alte prestazioni utilizzando la libreria C++ senza alcuna dipendenza." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da MPP a XLSX C++" offSpacer="" %}}
