---
title: Converti MPX in XER tramite l'applicazione C++ 
url: /it/cpp/conversion/mpx-to-xer/ 
description: Esempio di codice di conversione C++ per documento MPX in formato XER. Utilizzare il codice di esempio per la conversione batch da MPX a XER all'interno di qualsiasi applicazione C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti MPX in XER tramite C++" h2="Conversione da MPX a XER ad alte prestazioni utilizzando la libreria C++ senza alcuna dipendenza." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da MPX a XER C++" offSpacer="" %}}
