---
title: 通過 C# 將 XML 轉換為 MPP 
url: /zh-hant/net/conversion/xml-to-mpp/ 
description: XML 到 MPP C# 轉換的源代碼。使用 API 示例代碼在 VB.NET Asp.NET 或任何基於 .NET 的應用程序中將 XML 文件批量轉換為 MPP。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 XML 轉換為 MPP" h2="在 .NET Framework、Mono 和 COM 互操作上將 Microsoft® Project XML 導出為 MPP。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 XML 到 MPP C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 XML 轉換為 MPP 的免費應用程序" sectionDescription="Check our live demos for [XML to MPP conversion](https://products.aspose.app/tasks/conversion/xml-to-mpp) with following benefits." >}}
