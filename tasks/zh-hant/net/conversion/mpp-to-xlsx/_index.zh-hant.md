...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 MPP 到 XLSX C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 MPP 轉換為 XLSX 的免費應用程序" sectionDescription="Check our live demos for [MPP to XLSX conversion](https://products.aspose.app/tasks/conversion/mpp-to-xlsx) with following benefits." >}}
