---
title: 通過 C# 將 MPP 轉換為 HTML 
url: /zh-hant/net/conversion/mpp-to-html/ 
description: MPP 到 HTML C# 轉換的源代碼。使用 API 示例代碼在 VB.NET Asp.NET 或任何基於 .NET 的應用程序中將 MPP 文件批量轉換為 HTML。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 MPP 轉換為 HTML" h2="在 .NET Framework、Mono 和 COM 互操作上將 Microsoft® Project MPP 導出為 HTML。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 MPP 到 HTML C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 MPP 轉換為 HTML 的免費應用程序" sectionDescription="Check our live demos for [MPP to HTML conversion](https://products.aspose.app/tasks/conversion/mpp-to-html) with following benefits." >}}
