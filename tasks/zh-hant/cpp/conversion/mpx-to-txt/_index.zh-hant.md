---
title: 通過 C++ 應用程序將 MPX 轉換為 TXT 
url: /zh-hant/cpp/conversion/mpx-to-txt/ 
description: MPX 文檔到 TXT 格式的示例 C++ 轉換代碼。在任何 C++ 應用程序中使用示例代碼將 MPX 批量轉換為 TXT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將 MPX 轉換為 TXT" h2="使用 C++ 庫的高性能 MPX 到 TXT 轉換，沒有任何依賴。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="MPX 到 TXT C++ 轉換源代碼" offSpacer="" %}}
