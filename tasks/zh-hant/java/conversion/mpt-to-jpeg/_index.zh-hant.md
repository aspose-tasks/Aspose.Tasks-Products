---
title: 通過 Java 將 MPT 轉換為 JPEG 
url: /zh-hant/java/conversion/mpt-to-jpeg/ 
description: MPT 格式到 JPEG 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 MPT 轉換為 JPEG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 MPT 轉換為 JPEG" h2="使用本機 Java 庫將 Microsoft Visio MPT 導出為 JPEG，無需 Office 自動化。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MPT 轉換為 JPEG" %}}

為了將 MPT 呈現為 JPEG，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MPT 轉換為 JPEG 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT 到 JPEG Java 轉換源代碼" offSpacer="" %}}
