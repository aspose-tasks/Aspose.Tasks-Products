---
title: 通過 Java 將 MPX 轉換為 SVG 
url: /zh-hant/java/conversion/mpx-to-svg/ 
description: MPX 格式到 SVG 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 MPX 轉換為 SVG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 MPX 轉換為 SVG" h2="使用本機 Java 庫將 Microsoft Visio MPX 導出為 SVG，無需 Office 自動化。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MPX 轉換為 SVG" %}}

為了將 MPX 呈現為 SVG，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MPX 轉換為 SVG 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX 到 SVG Java 轉換源代碼" offSpacer="" %}}
