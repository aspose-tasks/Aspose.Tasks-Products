---
title: 通過 Java 將 XML 轉換為 PNG 
url: /zh-hant/java/conversion/xml-to-png/ 
description: XML 格式到 PNG 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 XML 轉換為 PNG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 XML 轉換為 PNG" h2="使用本機 Java 庫將 Microsoft Visio XML 導出為 PNG，無需 Office 自動化。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 XML 轉換為 PNG" %}}

為了將 XML 呈現為 PNG，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 XML 轉換為 PNG 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="XML 到 PNG Java 轉換源代碼" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 XML 轉換為 PNG 的免費應用程序" sectionDescription="[Convert XML to PNG](https://products.aspose.app/tasks/conversion/xml-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
