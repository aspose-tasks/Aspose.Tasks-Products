---
title: 通過 Java 將 MPP 轉換為 XER 
url: /zh-hant/java/conversion/mpp-to-xer/ 
description: MPP 格式到 XER 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 MPP 轉換為 XER。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 MPP 轉換為 XER" h2="使用本機 Java 庫將 Microsoft Visio MPP 導出為 XER，無需 Office 自動化。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MPP 轉換為 XER" %}}

為了將 MPP 呈現為 XER，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MPP 轉換為 XER 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP 到 XER Java 轉換源代碼" offSpacer="" %}}
