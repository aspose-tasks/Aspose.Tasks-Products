---
title: Převeďte MPT do XER pomocí aplikace C++ 
url: /cs/cpp/conversion/mpt-to-xer/ 
description: Ukázka převodního kódu C++ pro dokument MPT do formátu XER. Použijte ukázkový kód pro dávkový převod MPT do XER v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MPT do XER pomocí C++" h2="Vysoce výkonný převod MPT do XER pomocí knihovny C++ bez jakékoli závislosti." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MPT do XER pomocí C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MPT do XER C++" offSpacer="" %}}
