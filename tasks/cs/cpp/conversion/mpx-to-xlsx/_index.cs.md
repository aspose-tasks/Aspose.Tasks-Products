---
title: Převeďte MPX do XLSX pomocí aplikace C++ 
url: /cs/cpp/conversion/mpx-to-xlsx/ 
description: Ukázka převodního kódu C++ pro dokument MPX do formátu XLSX. Použijte ukázkový kód pro dávkový převod MPX do XLSX v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MPX do XLSX pomocí C++" h2="Vysoce výkonný převod MPX do XLSX pomocí knihovny C++ bez jakékoli závislosti." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MPX do XLSX pomocí C++" %}}

 Abychom převedli MPX do XLSX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MPX do XLSX pomocí C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MPX do XLSX C++" offSpacer="" %}}
