---
title: Převeďte XML do XLSX pomocí aplikace C++ 
url: /cs/cpp/conversion/xml-to-xlsx/ 
description: Ukázka převodního kódu C++ pro dokument XML do formátu XLSX. Použijte ukázkový kód pro dávkový převod XML do XLSX v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XML do XLSX pomocí C++" h2="Vysoce výkonný převod XML do XLSX pomocí knihovny C++ bez jakékoli závislosti." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést XML do XLSX pomocí C++" %}}

 Abychom převedli XML do XLSX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XML do XLSX pomocí C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XML do XLSX C++" offSpacer="" %}}
