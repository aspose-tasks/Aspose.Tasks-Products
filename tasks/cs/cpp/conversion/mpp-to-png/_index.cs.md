---
title: Převeďte MPP do PNG pomocí aplikace C++ 
url: /cs/cpp/conversion/mpp-to-png/ 
description: Ukázka převodního kódu C++ pro dokument MPP do formátu PNG. Použijte ukázkový kód pro dávkový převod MPP do PNG v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MPP do PNG pomocí C++" h2="Vysoce výkonný převod MPP do PNG pomocí knihovny C++ bez jakékoli závislosti." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MPP do PNG pomocí C++" %}}

 Abychom převedli MPP do PNG, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MPP do PNG pomocí C++" %}}
...
1. Předejte cestu výstupního souboru s příponou (PNG).
1. Soubor PNG bude uložen do zadané cesty.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MPP do PNG C++" offSpacer="" %}}
