---
title: Převést MPT do TXT přes Java 
url: /cs/java/conversion/mpt-to-txt/ 
description: Ukázkový konverzní kód Java pro formát MPT do souboru TXT. Tento příklad kódu použijte k převodu MPT na TXT v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést MPT do TXT přes Java" h2="Exportujte Microsoft Visio MPT do TXT pomocí nativní knihovny Java bez Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MPT do TXT pomocí Java" %}}

K vykreslení MPT do TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MPT do TXT přes Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MPT na TXT Java" offSpacer="" %}}
