---
title: Převést XML do HTML přes Java 
url: /cs/java/conversion/xml-to-html/ 
description: Ukázkový konverzní kód Java pro formát XML do souboru HTML. Tento příklad kódu použijte k převodu XML na HTML v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést XML do HTML přes Java" h2="Exportujte Microsoft Visio XML do HTML pomocí nativní knihovny Java bez Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést XML do HTML pomocí Java" %}}

K vykreslení XML do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XML do HTML přes Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XML na HTML Java" offSpacer="" %}}
