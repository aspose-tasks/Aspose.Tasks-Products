---
title: Převést MPT do PNG přes Java 
url: /cs/java/conversion/mpt-to-png/ 
description: Ukázkový konverzní kód Java pro formát MPT do souboru PNG. Tento příklad kódu použijte k převodu MPT na PNG v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést MPT do PNG přes Java" h2="Exportujte Microsoft Visio MPT do PNG pomocí nativní knihovny Java bez Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MPT do PNG pomocí Java" %}}

K vykreslení MPT do PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MPT do PNG přes Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MPT na PNG Java" offSpacer="" %}}
