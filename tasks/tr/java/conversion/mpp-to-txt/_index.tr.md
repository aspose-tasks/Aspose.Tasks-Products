---
title: Java ile MPP'yi TXT'ye dönüştürün 
url: /tr/java/conversion/mpp-to-txt/ 
description: MPP formatı için TXT dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada MPP'yi TXT'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile MPP'yi TXT'ye dönüştürün" h2="Office Otomasyonu olmadan yerel Java kitaplığını kullanarak Microsoft Visio MPP'yi TXT'ye aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak MPP'yi TXT'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile MPP'yi TXT'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP'den TXT'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
