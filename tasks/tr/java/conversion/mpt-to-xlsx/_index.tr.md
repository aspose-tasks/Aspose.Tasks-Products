---
title: Java ile MPT'yi XLSX'ye dönüştürün 
url: /tr/java/conversion/mpt-to-xlsx/ 
description: MPT formatı için XLSX dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada MPT'yi XLSX'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile MPT'yi XLSX'ye dönüştürün" h2="Office Otomasyonu olmadan yerel Java kitaplığını kullanarak Microsoft Visio MPT'yi XLSX'ye aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak MPT'yi XLSX'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile MPT'yi XLSX'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="MPT'den XLSX'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
