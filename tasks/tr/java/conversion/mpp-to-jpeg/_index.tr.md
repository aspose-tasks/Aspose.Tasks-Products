---
title: Java ile MPP'yi JPEG'ye dönüştürün 
url: /tr/java/conversion/mpp-to-jpeg/ 
description: MPP formatı için JPEG dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada MPP'yi JPEG'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile MPP'yi JPEG'ye dönüştürün" h2="Office Otomasyonu olmadan yerel Java kitaplığını kullanarak Microsoft Visio MPP'yi JPEG'ye aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak MPP'yi JPEG'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile MPP'yi JPEG'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="MPP'den JPEG'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="MPP'yi JPEG'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="[Convert MPP to JPEG](https://products.aspose.app/tasks/conversion/mpp-to-jpeg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
