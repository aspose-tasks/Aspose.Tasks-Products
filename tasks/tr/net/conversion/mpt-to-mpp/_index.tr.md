---
title: MPT'yi C# ile MPP'ye dönüştürün 
url: /tr/net/conversion/mpt-to-mpp/ 
description: MPT'den MPP'ye C# dönüşümü için kaynak kodu. VB.NET Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu MPT dosyalarını MPP'ye dönüştürmek için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPT'yi C# ile MPP'ye dönüştürün" h2="Microsoft® Project MPT'yi .NET Framework, Mono ve COM Interop üzerinde MPP'ye aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak MPT'yi MPP'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="MPT'yi C# ile MPP'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, MPT'den MPP'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="MPT'yi MPP'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Check our live demos for [MPT to MPP conversion](https://products.aspose.app/tasks/conversion/mpt-to-mpp) with following benefits." >}}
