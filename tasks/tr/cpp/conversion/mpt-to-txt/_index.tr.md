---
title: MPT'yi C++ uygulaması aracılığıyla TXT'ye dönüştürün 
url: /tr/cpp/conversion/mpt-to-txt/ 
description: MPT belgesi için TXT formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu MPT'den TXT'ye dönüştürme için örnek kod kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPT'yi C++ ile TXT'ye dönüştürün" h2="Herhangi bir bağımlılık olmaksızın C++ kitaplığını kullanarak yüksek performanslı MPT'den TXT'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/code-block title="MPT'den TXT'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
