---
title: MPX'yi C++ uygulaması aracılığıyla MPT'ye dönüştürün 
url: /tr/cpp/conversion/mpx-to-mpt/ 
description: MPX belgesi için MPT formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu MPX'den MPT'ye dönüştürme için örnek kod kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="MPX'yi C++ ile MPT'ye dönüştürün" h2="Herhangi bir bağımlılık olmaksızın C++ kitaplığını kullanarak yüksek performanslı MPX'den MPT'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak MPX'yi MPT'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="MPX'yi C++ ile MPT'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="MPX'den MPT'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
