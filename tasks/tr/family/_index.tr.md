---
title: Proje Yönetimi ve Manipülasyon için .NET Java ve C++ API'leri 
weight: 10
url: /tr/family
description: MS Project yüklü olmadan ilgili kitaplığı kullanarak .NET ve Java uygulamalarında Microsoft Project MPP MPT MPX XML dosyalarını oluşturun, düzenleyin, dönüştürün yazdırın ve işleyin
---
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" productLink="/tasks/tr/net/" >}}
...
{{< blocks/products/pf/product pfName=" Aspose.Tasks for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" productLink="/tasks/tr/java/" >}}
...
Microsoft Project® dosyalarını Microsoft Project® kullanmadan okumak, yazmak ve işlemek için C++ kitaplığı.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="belgeler" href="https://docs.aspose.com/tasks/" >}}
{{< blocks/products/pf/slr-element name="Kaynak kodu" href="https://github.com/aspose-tasks?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Neden Aspose.Tasks Ürün Ailesi?" tabId="success-stories" >}}
