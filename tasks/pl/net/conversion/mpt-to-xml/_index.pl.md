---
title: Konwertuj MPT na XML za pomocą C# 
url: /pl/net/conversion/mpt-to-xml/ 
description: Kod źródłowy konwersji MPT do XML C#. Użyj przykładowego kodu API dla plików MPT wsadowych do konwersji XML w VB.NET Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPT na XML za pomocą C#" h2="Eksportuj Microsoft® Project MPT do XML w .NET Framework, Mono i COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPT na XML za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję MPT do XML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPT na XML" sectionDescription="Check our live demos for [MPT to XML conversion](https://products.aspose.app/tasks/conversion/mpt-to-xml) with following benefits." >}}
