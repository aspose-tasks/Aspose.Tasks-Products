---
title: Konwertuj MPT na MPP za pomocą C# 
url: /pl/net/conversion/mpt-to-mpp/ 
description: Kod źródłowy konwersji MPT do MPP C#. Użyj przykładowego kodu API dla plików MPT wsadowych do konwersji MPP w VB.NET Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPT na MPP za pomocą C#" h2="Eksportuj Microsoft® Project MPT do MPP w .NET Framework, Mono i COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPP" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPT na MPP za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję MPT do MPP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPT na MPP" sectionDescription="Check our live demos for [MPT to MPP conversion](https://products.aspose.app/tasks/conversion/mpt-to-mpp) with following benefits." >}}
