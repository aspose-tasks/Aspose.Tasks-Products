---
title: Konwertuj MPP na XLSX za pomocą C# 
url: /pl/net/conversion/mpp-to-xlsx/ 
description: Kod źródłowy konwersji MPP do XLSX C#. Użyj przykładowego kodu API dla plików MPP wsadowych do konwersji XLSX w VB.NET Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPP na XLSX za pomocą C#" h2="Eksportuj Microsoft® Project MPP do XLSX w .NET Framework, Mono i COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPP na XLSX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję MPP do XLSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPP na XLSX" sectionDescription="Check our live demos for [MPP to XLSX conversion](https://products.aspose.app/tasks/conversion/mpp-to-xlsx) with following benefits." >}}
