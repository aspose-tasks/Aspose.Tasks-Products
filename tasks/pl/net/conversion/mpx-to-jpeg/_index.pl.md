---
title: Konwertuj MPX na JPEG za pomocą C# 
url: /pl/net/conversion/mpx-to-jpeg/ 
description: Kod źródłowy konwersji MPX do JPEG C#. Użyj przykładowego kodu API dla plików MPX wsadowych do konwersji JPEG w VB.NET Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPX na JPEG za pomocą C#" h2="Eksportuj Microsoft® Project MPX do JPEG w .NET Framework, Mono i COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPX na JPEG za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję MPX do JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPX na JPEG" sectionDescription="Check our live demos for [MPX to JPEG conversion](https://products.aspose.app/tasks/conversion/mpx-to-jpeg) with following benefits." >}}
