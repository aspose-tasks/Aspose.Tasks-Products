---
title: Konwertuj MPX na XER za pomocą C# 
url: /pl/net/conversion/mpx-to-xer/ 
description: Kod źródłowy konwersji MPX do XER C#. Użyj przykładowego kodu API dla plików MPX wsadowych do konwersji XER w VB.NET Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPX na XER za pomocą C#" h2="Eksportuj Microsoft® Project MPX do XER w .NET Framework, Mono i COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XER" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPX na XER za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję MPX do XER C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPX na XER" sectionDescription="Check our live demos for [MPX to XER conversion](https://products.aspose.app/tasks/conversion/mpx-to-xer) with following benefits." >}}
