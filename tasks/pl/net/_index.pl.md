...
<h2 class="h2title">Obsługuj zadania w projekcie</h2>

<p>Aspose.Tasks dla platformy .NET udostępnia bogaty zestaw klas do obsługi zadań w pliku Microsoft Projekt. Plany projektów mogą mieć różną złożoność, od prostej płaskiej listy zadań do dużej zagnieżdżonej grupy współzależnych zadań. Niezależnie od złożoności Aspose.Tasks for .NET jest w stanie poradzić sobie z każdym scenariuszem.</p>
