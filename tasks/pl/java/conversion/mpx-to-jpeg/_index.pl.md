---
title: Konwertuj MPX na JPEG za pomocą Java 
url: /pl/java/conversion/mpx-to-jpeg/ 
description: Przykładowy kod konwersji Java dla formatu MPX do pliku JPEG. Użyj tego przykładowego kodu, aby przekonwertować MPX na JPEG w dowolnej aplikacji internetowej lub aplikacji opartej na języku Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPX na JPEG za pomocą Java" h2="Eksportuj Microsoft Visio MPX do JPEG przy użyciu natywnej biblioteki Java bez automatyzacji pakietu Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MPX na JPEG za pomocą Java" %}}

Aby wyrenderować MPX do JPEG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MPX na JPEG za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MPX do JPEG Java" offSpacer="" %}}
