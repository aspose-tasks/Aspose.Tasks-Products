---
title: Konwertuj MPP na XLSX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/mpp-to-xlsx/ 
description: Przykładowy kod konwersji C++ dla dokumentu MPP do formatu XLSX. Użyj przykładowego kodu do wsadowej konwersji MPP na XLSX w dowolnej aplikacji C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPP na XLSX za pomocą C++" h2="Wysokowydajna konwersja MPP do XLSX przy użyciu biblioteki C++ bez żadnych zależności." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MPP na XLSX za pomocą C++" %}}

 Aby przekonwertować MPP na XLSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do konwersji MPP na XLSX za pomocą C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MPP do XLSX C++" offSpacer="" %}}
