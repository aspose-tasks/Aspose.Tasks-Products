---
title: Konwertuj MPT na PNG za pomocą aplikacji C++ 
url: /pl/cpp/conversion/mpt-to-png/ 
description: Przykładowy kod konwersji C++ dla dokumentu MPT do formatu PNG. Użyj przykładowego kodu do wsadowej konwersji MPT na PNG w dowolnej aplikacji C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPT na PNG za pomocą C++" h2="Wysokowydajna konwersja MPT do PNG przy użyciu biblioteki C++ bez żadnych zależności." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do konwersji MPT na PNG za pomocą C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MPT do PNG C++" offSpacer="" %}}
