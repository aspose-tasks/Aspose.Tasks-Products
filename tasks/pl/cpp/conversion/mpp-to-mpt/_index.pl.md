---
title: Konwertuj MPP na MPT za pomocą aplikacji C++ 
url: /pl/cpp/conversion/mpp-to-mpt/ 
description: Przykładowy kod konwersji C++ dla dokumentu MPP do formatu MPT. Użyj przykładowego kodu do wsadowej konwersji MPP na MPT w dowolnej aplikacji C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MPP na MPT za pomocą C++" h2="Wysokowydajna konwersja MPP do MPT przy użyciu biblioteki C++ bez żadnych zależności." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MPP na MPT za pomocą C++" %}}

 Aby przekonwertować MPP na MPT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do konwersji MPP na MPT za pomocą C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MPP do MPT C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji MPP na MPT" sectionDescription="[Convert MPP to MPT](https://products.aspose.app/tasks/conversion/mpp-to-mpt) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
