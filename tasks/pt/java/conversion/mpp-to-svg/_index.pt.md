---
title: Converter MPP para SVG via Java 
url: /pt/java/conversion/mpp-to-svg/ 
description: Exemplo de código de conversão Java para formato MPP para arquivo SVG. Use este código de exemplo para converter MPP para SVG em qualquer aplicativo baseado em Java Web ou Desktop.
---
...
{{% blocks/products/pf/agp/content h2="Como converter MPP para SVG usando Java" %}}

Para renderizar MPP para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter MPP para SVG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MPP para SVG Java" offSpacer="" %}}
