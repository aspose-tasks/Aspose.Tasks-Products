---
title: Converter MPP para JPEG via Java 
url: /pt/java/conversion/mpp-to-jpeg/ 
description: Exemplo de código de conversão Java para formato MPP para arquivo JPEG. Use este código de exemplo para converter MPP para JPEG em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MPP para JPEG via Java" h2="Exporte o Microsoft Visio MPP para JPEG usando a biblioteca Java nativa sem Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MPP para JPEG usando Java" %}}

Para renderizar MPP para JPEG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter MPP para JPEG via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MPP para JPEG Java" offSpacer="" %}}
