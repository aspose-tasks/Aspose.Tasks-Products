---
title: Converter MPX para MPT via aplicativo C++ 
url: /pt/cpp/conversion/mpx-to-mpt/ 
description: Exemplo de código de conversão C++ para documento MPX para formato MPT. Use o código de exemplo para conversão em lote de MPX para MPT em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MPX para MPT via C++" h2="Conversão de MPX para MPT de alto desempenho usando biblioteca C++ sem qualquer dependência." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MPX para MPT usando C++" %}}

 Para converter MPX para MPT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MPX para MPT via C++" %}}
...
1. Passe o caminho do arquivo de saída com extensão de arquivo (MPT).
1. O arquivo MPT será salvo no caminho especificado.
1. Abra o arquivo MPT em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MPX para MPT C++" offSpacer="" %}}
