---
title: Converter MPP para PNG via aplicativo C++ 
url: /pt/cpp/conversion/mpp-to-png/ 
description: Exemplo de código de conversão C++ para documento MPP para formato PNG. Use o código de exemplo para conversão em lote de MPP para PNG em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MPP para PNG via C++" h2="Conversão de MPP para PNG de alto desempenho usando biblioteca C++ sem qualquer dependência." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MPP para PNG C++" offSpacer="" %}}
