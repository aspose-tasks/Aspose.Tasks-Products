---
title: Converter MPT para XLSX via aplicativo C++ 
url: /pt/cpp/conversion/mpt-to-xlsx/ 
description: Exemplo de código de conversão C++ para documento MPT para formato XLSX. Use o código de exemplo para conversão em lote de MPT para XLSX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MPT para XLSX via C++" h2="Conversão de MPT para XLSX de alto desempenho usando biblioteca C++ sem qualquer dependência." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MPT para XLSX usando C++" %}}

 Para converter MPT para XLSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MPT para XLSX via C++" %}}
...
1. Passe o caminho do arquivo de saída com extensão de arquivo (XLSX).
1. O arquivo XLSX será salvo no caminho especificado.
1. Abra o arquivo XLSX em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MPT para XLSX C++" offSpacer="" %}}
