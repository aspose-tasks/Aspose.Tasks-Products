---
title: Преобразование MPX в SVG через Java 
url: /ru/java/conversion/mpx-to-svg/ 
description: Пример кода преобразования Java для формата MPX в файл SVG. Используйте этот пример кода для преобразования MPX в SVG в любом веб-приложении или приложении для рабочего стола на основе Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование MPX в SVG через Java" h2="Экспорт Microsoft Visio MPX в SVG с использованием собственной библиотеки Java без автоматизации Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать MPX в SVG с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования MPX в SVG через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования MPX в SVG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для преобразования MPX в SVG" sectionDescription="[Convert MPX to SVG](https://products.aspose.app/tasks/conversion/mpx-to-svg) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
