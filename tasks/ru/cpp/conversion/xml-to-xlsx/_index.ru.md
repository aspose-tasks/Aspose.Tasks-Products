---
title: Преобразование XML в XLSX с помощью приложения C++ 
url: /ru/cpp/conversion/xml-to-xlsx/ 
description: Пример кода преобразования C++ для документа XML в формат XLSX. Используйте пример кода для пакетного преобразования XML в XLSX в любом приложении C++.
---
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XML в XLSX с помощью C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования XML в XLSX C++" offSpacer="" %}}
