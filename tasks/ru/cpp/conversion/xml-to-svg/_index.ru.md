---
title: Преобразование XML в SVG с помощью приложения C++ 
url: /ru/cpp/conversion/xml-to-svg/ 
description: Пример кода преобразования C++ для документа XML в формат SVG. Используйте пример кода для пакетного преобразования XML в SVG в любом приложении C++.
---
