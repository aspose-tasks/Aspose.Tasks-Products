---
title: Преобразование XML в HTML через C# 
url: /ru/net/conversion/xml-to-html/ 
description: Исходный код для преобразования XML в HTML C#. Используйте пример кода API для пакетного преобразования файлов XML в HTML в VB.NET Asp.NET или любом приложении на основе .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование XML в HTML через C#" h2="Экспорт Microsoft® Project XML в HTML для .NET Framework, Mono и COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в HTML с помощью C#" %}}
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование XML в HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для преобразования XML в HTML" sectionDescription="Check our live demos for [XML to HTML conversion](https://products.aspose.app/tasks/conversion/xml-to-html) with following benefits." >}}
