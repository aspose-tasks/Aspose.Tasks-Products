...
{{% blocks/products/pf/agp/feature-section-col title="Convert XML to PDF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XML to PDF Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/faq imgSrc="https://www.aspose.com/templates/brand/images/tasks/aspose_tasks-brand.png" >}}
    ...
    {{< blocks/products/pf/agp/faq-item question="Can I convert XML to PDF on operating systems other than Windows?" answer="You can execute the code on any operating system that has Java environment, that includes Windows, Linux and macOS." >}}
    {{< blocks/products/pf/agp/faq-item question="Can I convert XML to PDF via .NET?" answer="Sure. Aspose.Tasks is available for .NET as well. Checkout [C# code for XML to PDF conversion](https://products.aspose.com/tasks/net/conversion/xml-to-pdf\)." >}}
    {{< blocks/products/pf/agp/faq-item question="I do not have time to set up. Do you have a demo that I can try?" answer="Indeed. Try [XML to PDF Demo](https://products.aspose.app/tasks/conversion/) to quickly check the conversion results." >}}
