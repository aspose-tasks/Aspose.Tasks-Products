---
title: Convertir XML a PDF a través de Java 
url: /es/java/conversion/xml-to-pdf/ 
description: Ejemplo de código de conversión de Java para formato XML a archivo PDF. Utilice este código de ejemplo para convertir XML a PDF dentro de cualquier aplicación basada en Web o Java de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XML a PDF a través de Java" h2="Exporte Microsoft Visio XML a PDF utilizando la biblioteca nativa de Java sin Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XML a PDF usando Java" %}}

Para renderizar XML a PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XML a PDF a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XML a PDF Java" offSpacer="" %}}
