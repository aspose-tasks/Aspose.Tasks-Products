...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPP a MPX usando Java" %}}

Para renderizar MPP a MPX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPP a MPX a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPP a MPX Java" offSpacer="" %}}
