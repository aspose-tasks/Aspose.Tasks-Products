---
title: Convertir MPP a TXT a través de Java 
url: /es/java/conversion/mpp-to-txt/ 
description: Ejemplo de código de conversión de Java para formato MPP a archivo TXT. Utilice este código de ejemplo para convertir MPP a TXT dentro de cualquier aplicación basada en Web o Java de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPP a TXT a través de Java" h2="Exporte Microsoft Visio MPP a TXT utilizando la biblioteca nativa de Java sin Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPP a TXT usando Java" %}}

Para renderizar MPP a TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPP a TXT a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPP a TXT Java" offSpacer="" %}}
