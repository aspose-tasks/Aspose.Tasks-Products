---
title: Convertir MPT a XLSX a través de Java 
url: /es/java/conversion/mpt-to-xlsx/ 
description: Ejemplo de código de conversión de Java para formato MPT a archivo XLSX. Utilice este código de ejemplo para convertir MPT a XLSX dentro de cualquier aplicación basada en Web o Java de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MPT a XLSX a través de Java" h2="Exporte Microsoft Visio MPT a XLSX utilizando la biblioteca nativa de Java sin Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPT a XLSX usando Java" %}}

Para renderizar MPT a XLSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPT a XLSX a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPT a XLSX Java" offSpacer="" %}}
