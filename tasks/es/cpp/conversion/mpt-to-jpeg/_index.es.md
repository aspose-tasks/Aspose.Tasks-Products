---
title: Convierta MPT a JPEG a través de la aplicación C ++ 
url: /es/cpp/conversion/mpt-to-jpeg/ 
description: Ejemplo de código de conversión de C++ para documento MPT a formato JPEG. Utilice un código de ejemplo para la conversión por lotes de MPT a JPEG dentro de cualquier aplicación C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPT a JPEG a través de C++" h2="Conversión de MPT a JPEG de alto rendimiento utilizando la biblioteca C++ sin ninguna dependencia." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPT a JPEG usando C++" %}}

 Para convertir MPT a JPEG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPT a JPEG a través de C++" %}}
...
1. Pase la ruta del archivo de salida con extensión de archivo (JPEG).
1. El archivo JPEG se guardará en la ruta especificada.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPT a JPEG C++" offSpacer="" %}}
