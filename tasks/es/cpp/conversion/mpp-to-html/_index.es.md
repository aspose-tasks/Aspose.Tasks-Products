---
title: Convierta MPP a HTML a través de la aplicación C ++ 
url: /es/cpp/conversion/mpp-to-html/ 
description: Ejemplo de código de conversión de C++ para documento MPP a formato HTML. Utilice un código de ejemplo para la conversión por lotes de MPP a HTML dentro de cualquier aplicación C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPP a HTML a través de C++" h2="Conversión de MPP a HTML de alto rendimiento utilizando la biblioteca C++ sin ninguna dependencia." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPP a HTML usando C++" %}}

 Para convertir MPP a HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPP a HTML a través de C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPP a HTML C++" offSpacer="" %}}
