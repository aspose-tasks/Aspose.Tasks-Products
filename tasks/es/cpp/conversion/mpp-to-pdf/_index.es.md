---
title: Convierta MPP a PDF a través de la aplicación C ++ 
url: /es/cpp/conversion/mpp-to-pdf/ 
description: Ejemplo de código de conversión de C++ para documento MPP a formato PDF. Utilice un código de ejemplo para la conversión por lotes de MPP a PDF dentro de cualquier aplicación C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPP a PDF a través de C++" h2="Conversión de MPP a PDF de alto rendimiento utilizando la biblioteca C++ sin ninguna dependencia." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPP a PDF C++" offSpacer="" %}}
