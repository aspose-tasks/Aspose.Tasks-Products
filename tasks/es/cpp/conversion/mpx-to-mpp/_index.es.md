---
title: Convierta MPX a MPP a través de la aplicación C ++ 
url: /es/cpp/conversion/mpx-to-mpp/ 
description: Ejemplo de código de conversión de C++ para documento MPX a formato MPP. Utilice un código de ejemplo para la conversión por lotes de MPX a MPP dentro de cualquier aplicación C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPX a MPP a través de C++" h2="Conversión de MPX a MPP de alto rendimiento utilizando la biblioteca C++ sin ninguna dependencia." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MPX a MPP C++" offSpacer="" %}}
