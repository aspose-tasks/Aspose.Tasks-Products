---
title: Convierta XML a TXT a través de la aplicación C ++ 
url: /es/cpp/conversion/xml-to-txt/ 
description: Ejemplo de código de conversión de C++ para documento XML a formato TXT. Utilice un código de ejemplo para la conversión por lotes de XML a TXT dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XML a TXT C++" offSpacer="" %}}
