---
title: Convierta MPX a XML a través de C# 
url: /es/net/conversion/mpx-to-xml/ 
description: Código fuente para la conversión de MPX a XML C#. Utilice el código de ejemplo de API para la conversión de archivos MPX por lotes a XML dentro de VB.NET Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPX a XML a través de C#" h2="Exporte Microsoft® Project MPX a XML en .NET Framework, Mono y COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="XML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MPX a XML usando C#" %}}

Para convertir MPX a XML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir MPX a XML a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de MPX a XML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir MPX a XML" sectionDescription="Check our live demos for [MPX to XML conversion](https://products.aspose.app/tasks/conversion/mpx-to-xml) with following benefits." >}}
