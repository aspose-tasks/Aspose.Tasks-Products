---
title: Convierta MPT a JPEG a través de C# 
url: /es/net/conversion/mpt-to-jpeg/ 
description: Código fuente para la conversión de MPT a JPEG C#. Utilice el código de ejemplo de API para la conversión de archivos MPT por lotes a JPEG dentro de VB.NET Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta MPT a JPEG a través de C#" h2="Exporte Microsoft® Project MPT a JPEG en .NET Framework, Mono y COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de MPT a JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir MPT a JPEG" sectionDescription="Check our live demos for [MPT to JPEG conversion](https://products.aspose.app/tasks/conversion/mpt-to-jpeg) with following benefits." >}}
