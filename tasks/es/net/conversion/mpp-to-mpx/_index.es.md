---
title: Convierta MPP a MPX a través de C# 
url: /es/net/conversion/mpp-to-mpx/ 
description: Código fuente para la conversión de MPP a MPX C#. Utilice el código de ejemplo de API para la conversión de archivos MPP por lotes a MPX dentro de VB.NET Asp.NET o cualquier aplicación basada en .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de MPP a MPX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir MPP a MPX" sectionDescription="Check our live demos for [MPP to MPX conversion](https://products.aspose.app/tasks/conversion/mpp-to-mpx) with following benefits." >}}
