---
title: Convierta XML a PDF a través de C# 
url: /es/net/conversion/xml-to-pdf/ 
description: Código fuente para la conversión de XML a PDF C#. Utilice el código de ejemplo de API para la conversión de archivos XML por lotes a PDF dentro de VB.NET Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XML a PDF a través de C#" h2="Exporte Microsoft® Project XML a PDF en .NET Framework, Mono y COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de XML a PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir XML a PDF" sectionDescription="Check our live demos for [XML to PDF conversion](https://products.aspose.app/tasks/conversion/xml-to-pdf) with following benefits." >}}
