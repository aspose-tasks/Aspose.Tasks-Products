---
title: Javaを介してMPXをXLSXに変換する 
url: /ja/java/conversion/mpx-to-xlsx/ 
description: MPX形式からXLSXファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でMPXをXLSXに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してMPXをXLSXに変換する" h2="Office Automationを使用せずにネイティブJavaライブラリを使用して、MicrosoftVisioMPXをXLSXにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してMPXをXLSXに変換する方法" %}}

MPXをXLSXにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してMPXをXLSXに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="MPXからXLSXへのJava変換ソースコード" offSpacer="" %}}
