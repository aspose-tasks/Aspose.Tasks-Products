---
title: Javaを介してMPTをXERに変換する 
url: /ja/java/conversion/mpt-to-xer/ 
description: MPT形式からXERファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でMPTをXERに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してMPTをXERに変換する" h2="Office Automationを使用せずにネイティブJavaライブラリを使用して、MicrosoftVisioMPTをXERにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XER" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してMPTをXERに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してMPTをXERに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="MPTからXERへのJava変換ソースコード" offSpacer="" %}}
