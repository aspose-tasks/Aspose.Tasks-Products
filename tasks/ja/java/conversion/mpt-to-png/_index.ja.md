---
title: Javaを介してMPTをPNGに変換する 
url: /ja/java/conversion/mpt-to-png/ 
description: MPT形式からPNGファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でMPTをPNGに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してMPTをPNGに変換する" h2="Office Automationを使用せずにネイティブJavaライブラリを使用して、MicrosoftVisioMPTをPNGにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPT" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してMPTをPNGに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してMPTをPNGに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="MPTからPNGへのJava変換ソースコード" offSpacer="" %}}
