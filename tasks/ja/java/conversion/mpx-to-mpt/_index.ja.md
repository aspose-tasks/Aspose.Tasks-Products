---
title: Javaを介してMPXをMPTに変換する 
url: /ja/java/conversion/mpx-to-mpt/ 
description: MPX形式からMPTファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でMPXをMPTに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してMPXをMPTに変換する" h2="Office Automationを使用せずにネイティブJavaライブラリを使用して、MicrosoftVisioMPXをMPTにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してMPXをMPTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してMPXをMPTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="MPXからMPTへのJava変換ソースコード" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="MPXをMPTに変換する無料アプリ" sectionDescription="[Convert MPX to MPT](https://products.aspose.app/tasks/conversion/mpx-to-mpt) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
