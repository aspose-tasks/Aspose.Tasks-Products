...
{{% blocks/products/pf/agp/content h2="C++を使用してMPPをTXTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してMPPをTXTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="MPPからTXTC++への変換ソースコード" offSpacer="" %}}
