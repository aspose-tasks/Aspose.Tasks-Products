---
title: C++アプリケーションを介してXMLをMPPに変換する 
url: /ja/cpp/conversion/xml-to-mpp/ 
description: XMLドキュメントからMPP形式へのサンプルC++変換コード。任意のC++アプリケーション内でのバッチXMLからMPPへの変換にサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してXMLをMPPに変換する" h2="依存関係のないC++ライブラリを使用した高性能XMLからMPPへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="C++を使用してXMLをMPPに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してXMLをMPPに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="XMLからMPPC++への変換ソースコード" offSpacer="" %}}
