---
title: C＃を介してXMLをMPTに変換する 
url: /ja/net/conversion/xml-to-mpt/ 
description: XMLからMPTC＃への変換のソースコード。 VB.NETAsp.NETまたは任意の.NETベースのアプリケーション内でのバッチXMLファイルからMPTへの変換にAPIサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してXMLをMPTに変換する" h2="Microsoft®ProjectXMLを.NETFramework、Mono、およびCOM相互運用機能のMPTにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="MPT" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してXMLをMPTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してXMLをMPTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、XMLからMPTへのC＃変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="XMLをMPTに変換する無料アプリ" sectionDescription="Check our live demos for [XML to MPT conversion](https://products.aspose.app/tasks/conversion/xml-to-mpt) with following benefits." >}}
