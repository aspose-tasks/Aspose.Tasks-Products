---
title: C＃を介してMPPをJPEGに変換する 
url: /ja/net/conversion/mpp-to-jpeg/ 
description: MPPからJPEGC＃への変換のソースコード。 VB.NETAsp.NETまたは任意の.NETベースのアプリケーション内でのバッチMPPファイルからJPEGへの変換にAPIサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してMPPをJPEGに変換する" h2="Microsoft®ProjectMPPを.NETFramework、Mono、およびCOM相互運用機能のJPEGにエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/tasks/aspose_tasks-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MPP" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、MPPからJPEGへのC＃変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="MPPをJPEGに変換する無料アプリ" sectionDescription="Check our live demos for [MPP to JPEG conversion](https://products.aspose.app/tasks/conversion/mpp-to-jpeg) with following benefits." >}}
